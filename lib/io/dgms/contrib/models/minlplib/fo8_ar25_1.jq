...
module namespace ns = "http://dgms.io/contrib/models/minlplib/fo8_ar25_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:fo8_ar25_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e61": -((0.395288 * $x76) - (0.158112 * $x78)) <= -2.0,
            "e62": -((0.158113 * $x76) - (0.395288 * $x78)) <= -2.0,
            "e63": -((0.395288 * $x77) - (0.158112 * $x79)) <= -2.0,
            "e64": -((0.158113 * $x77) - (0.395288 * $x79)) <= -2.0,
            "e65": -((0.395288 * $x80) - (0.158112 * $x82)) <= -2.0,
            "e66": -((0.158113 * $x80) - (0.395288 * $x82)) <= -2.0,
            "e67": -((0.263525 * $x84) - (0.105408 * $x86)) <= -2.0,
            "e68": -((0.10541 * $x84) - (0.263522 * $x86)) <= -2.0,
            "e69": -((0.263525 * $x88) - (0.105408 * $x90)) <= -2.0,
            "e70": -((0.10541 * $x88) - (0.263522 * $x90)) <= -2.0,
            "e71": -((0.527037 * $x92) - (0.210822 * $x94)) <= -2.0,
            "e72": -((0.210819 * $x92) - (0.527044 * $x94)) <= -2.0,
            "e73": -((0.527037 * $x96) - (0.210822 * $x98)) <= -2.0,
            "e74": -((0.210819 * $x96) - (0.527044 * $x98)) <= -2.0,
            "e75": -((0.527037 * $x100) - (0.210822 * $x102)) <= -2.0,
            "e76": -((0.210819 * $x100) - (0.527044 * $x102)) <= -2.0,
