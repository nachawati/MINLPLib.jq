...
module namespace ns = "http://dgms.io/contrib/models/minlplib/st_fp7b";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:st_fp7b($input)
{
    let $x1 := $input.x1
    let $x2 := $input.x2
    let $x3 := $input.x3
    ...
    let $x20 := $input.x20
    return {
        "obj": (((((((((((((((((((((((((((((((((((((((-(0.5 * math:pow($x1, 2.0)) - (5.0 * $x1)) - (0.5 * math:pow($x2, 2.0))) - (5.0 * $x2)) - (0.5 * math:pow($x3, 2.0))) - (5.0 * $x3)) - (0.5 * math:pow($x4, 2.0))) - (5.0 * $x4)) - (0.5 * math:pow($x5, 2.0))) - (5.0 * $x5)) - (0.5 * math:pow($x6, 2.0))) - (5.0 * $x6)) - (0.5 * math:pow($x7, 2.0))) - (5.0 * $x7)) - (0.5 * math:pow($x8, 2.0))) - (5.0 * $x8)) - (0.5 * math:pow($x9, 2.0))) - (5.0 * $x9)) - (0.5 * math:pow($x10, 2.0))) - (5.0 * $x10)) - (0.5 * math:pow($x11, 2.0))) - (5.0 * $x11)) - (0.5 * math:pow($x12, 2.0))) - (5.0 * $x12)) - (0.5 * math:pow($x13, 2.0))) - (5.0 * $x13)) - (0.5 * math:pow($x14, 2.0))) - (5.0 * $x14)) - (0.5 * math:pow($x15, 2.0))) - (5.0 * $x15)) - (0.5 * math:pow($x16, 2.0))) - (5.0 * $x16)) - (0.5 * math:pow($x17, 2.0))) - (5.0 * $x17)) - (0.5 * math:pow($x18, 2.0))) - (5.0 * $x18)) - (0.5 * math:pow($x19, 2.0))) - (5.0 * $x19)) - (0.5 * math:pow($x20, 2.0))) - (5.0 * $x20)),
        "constraints": {
