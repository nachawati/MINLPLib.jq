...
module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circlesrectangles_c1r13";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:kall_circlesrectangles_c1r13($input)
{
    let $x1 := $input.x1
    let $x2 := $input.x2
    let $x3 := $input.x3
