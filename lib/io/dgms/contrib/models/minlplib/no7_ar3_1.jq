...
module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar3_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:no7_ar3_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e47": -((0.433013 * $x66) - (0.144338 * $x69)) <= -2.0,
            "e48": -((0.144338 * $x66) - (0.433013 * $x69)) <= -2.0,
            "e49": -((0.433013 * $x67) - (0.144338 * $x70)) <= -2.0,
            "e50": -((0.144338 * $x67) - (0.433013 * $x70)) <= -2.0,
            "e51": -((0.433013 * $x72) - (0.144338 * $x74)) <= -2.0,
            "e52": -((0.144338 * $x72) - (0.433013 * $x74)) <= -2.0,
            "e53": -((0.288675 * $x76) - (0.096225 * $x77)) <= -2.0,
            "e54": -((0.117096 * $x76) - (0.237222 * $x77)) <= -2.0,
            "e55": -((0.577334 * $x78) - (0.192456 * $x80)) <= -2.0,
            "e56": -((0.192448 * $x78) - (0.577356 * $x80)) <= -2.0,
            "e57": -((0.577334 * $x82) - (0.192456 * $x84)) <= -2.0,
            "e58": -((0.192448 * $x82) - (0.577356 * $x84)) <= -2.0,
            "e59": -((0.577334 * $x86) - (0.192456 * $x87)) <= -2.0,
            "e60": -((0.192448 * $x86) - (0.577356 * $x87)) <= -2.0,
