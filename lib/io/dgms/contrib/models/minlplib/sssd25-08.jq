...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd25-08";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd25-08($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e65": -($b223 + $x255) <= 0.0,
            "e66": -($b224 + $x256) <= 0.0,
            "e67": -(($x225 idiv (1.0 + $x225)) + $x233) <= 0.0,
            "e68": -(($x225 idiv (1.0 + $x225)) + $x234) <= 0.0,
            "e69": -(($x225 idiv (1.0 + $x225)) + $x235) <= 0.0,
            "e70": -(($x226 idiv (1.0 + $x226)) + $x236) <= 0.0,
            "e71": -(($x226 idiv (1.0 + $x226)) + $x237) <= 0.0,
            "e72": -(($x226 idiv (1.0 + $x226)) + $x238) <= 0.0,
            "e73": -(($x227 idiv (1.0 + $x227)) + $x239) <= 0.0,
            "e74": -(($x227 idiv (1.0 + $x227)) + $x240) <= 0.0,
            "e75": -(($x227 idiv (1.0 + $x227)) + $x241) <= 0.0,
            "e76": -(($x228 idiv (1.0 + $x228)) + $x242) <= 0.0,
            "e77": -(($x228 idiv (1.0 + $x228)) + $x243) <= 0.0,
            "e78": -(($x228 idiv (1.0 + $x228)) + $x244) <= 0.0,
            "e79": -(($x229 idiv (1.0 + $x229)) + $x245) <= 0.0,
            "e80": -(($x229 idiv (1.0 + $x229)) + $x246) <= 0.0,
            "e81": -(($x229 idiv (1.0 + $x229)) + $x247) <= 0.0,
            "e82": -(($x230 idiv (1.0 + $x230)) + $x248) <= 0.0,
            "e83": -(($x230 idiv (1.0 + $x230)) + $x249) <= 0.0,
            "e84": -(($x230 idiv (1.0 + $x230)) + $x250) <= 0.0,
            "e85": -(($x231 idiv (1.0 + $x231)) + $x251) <= 0.0,
            "e86": -(($x231 idiv (1.0 + $x231)) + $x252) <= 0.0,
            "e87": -(($x231 idiv (1.0 + $x231)) + $x253) <= 0.0,
            "e88": -(($x232 idiv (1.0 + $x232)) + $x254) <= 0.0,
            "e89": -(($x232 idiv (1.0 + $x232)) + $x255) <= 0.0,
            "e90": -(($x232 idiv (1.0 + $x232)) + $x256) <= 0.0
        }
    }
};
