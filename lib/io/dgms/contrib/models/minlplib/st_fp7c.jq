...
module namespace ns = "http://dgms.io/contrib/models/minlplib/st_fp7c";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:st_fp7c($input)
{
    let $x1 := $input.x1
    let $x2 := $input.x2
    let $x3 := $input.x3
    ...
    let $x20 := $input.x20
    return {
        "obj": (((((((((((((((((((-(10.0 * math:pow($x1, 2.0)) - (10.0 * math:pow($x2, 2.0))) - (10.0 * math:pow($x3, 2.0))) - (10.0 * math:pow($x4, 2.0))) - (10.0 * math:pow($x5, 2.0))) - (10.0 * math:pow($x6, 2.0))) - (10.0 * math:pow($x7, 2.0))) - (10.0 * math:pow($x8, 2.0))) - (10.0 * math:pow($x9, 2.0))) - (10.0 * math:pow($x10, 2.0))) - (10.0 * math:pow($x11, 2.0))) - (10.0 * math:pow($x12, 2.0))) - (10.0 * math:pow($x13, 2.0))) - (10.0 * math:pow($x14, 2.0))) - (10.0 * math:pow($x15, 2.0))) - (10.0 * math:pow($x16, 2.0))) - (10.0 * math:pow($x17, 2.0))) - (10.0 * math:pow($x18, 2.0))) - (10.0 * math:pow($x19, 2.0))) - (10.0 * math:pow($x20, 2.0))),
        "constraints": {
