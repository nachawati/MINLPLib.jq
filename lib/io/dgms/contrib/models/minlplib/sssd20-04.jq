...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd20-04";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd20-04($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e40": -($b91 + $x107) <= 0.0,
            "e41": -($b92 + $x108) <= 0.0,
            "e42": -(($x93 idiv (1.0 + $x93)) + $x97) <= 0.0,
            "e43": -(($x93 idiv (1.0 + $x93)) + $x98) <= 0.0,
            "e44": -(($x93 idiv (1.0 + $x93)) + $x99) <= 0.0,
            "e45": -(($x94 idiv (1.0 + $x94)) + $x100) <= 0.0,
            "e46": -(($x94 idiv (1.0 + $x94)) + $x101) <= 0.0,
            "e47": -(($x94 idiv (1.0 + $x94)) + $x102) <= 0.0,
            "e48": -(($x95 idiv (1.0 + $x95)) + $x103) <= 0.0,
            "e49": -(($x95 idiv (1.0 + $x95)) + $x104) <= 0.0,
            "e50": -(($x95 idiv (1.0 + $x95)) + $x105) <= 0.0,
            "e51": -(($x96 idiv (1.0 + $x96)) + $x106) <= 0.0,
            "e52": -(($x96 idiv (1.0 + $x96)) + $x107) <= 0.0,
            "e53": -(($x96 idiv (1.0 + $x96)) + $x108) <= 0.0
        }
    }
};
