...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd08-04";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd08-04($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e28": -($b43 + $x59) <= 0.0,
            "e29": -($b44 + $x60) <= 0.0,
            "e30": -(($x45 idiv (1.0 + $x45)) + $x49) <= 0.0,
            "e31": -(($x45 idiv (1.0 + $x45)) + $x50) <= 0.0,
            "e32": -(($x45 idiv (1.0 + $x45)) + $x51) <= 0.0,
            "e33": -(($x46 idiv (1.0 + $x46)) + $x52) <= 0.0,
            "e34": -(($x46 idiv (1.0 + $x46)) + $x53) <= 0.0,
            "e35": -(($x46 idiv (1.0 + $x46)) + $x54) <= 0.0,
            "e36": -(($x47 idiv (1.0 + $x47)) + $x55) <= 0.0,
            "e37": -(($x47 idiv (1.0 + $x47)) + $x56) <= 0.0,
            "e38": -(($x47 idiv (1.0 + $x47)) + $x57) <= 0.0,
            "e39": -(($x48 idiv (1.0 + $x48)) + $x58) <= 0.0,
            "e40": -(($x48 idiv (1.0 + $x48)) + $x59) <= 0.0,
            "e41": -(($x48 idiv (1.0 + $x48)) + $x60) <= 0.0
        }
    }
};
