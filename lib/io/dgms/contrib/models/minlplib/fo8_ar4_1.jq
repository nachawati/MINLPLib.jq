...
module namespace ns = "http://dgms.io/contrib/models/minlplib/fo8_ar4_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:fo8_ar4_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e61": -((0.5 * $x76) - (0.125 * $x78)) <= -2.0,
            "e62": -((0.125 * $x76) - (0.5 * $x78)) <= -2.0,
            "e63": -((0.5 * $x77) - (0.125 * $x79)) <= -2.0,
            "e64": -((0.125 * $x77) - (0.5 * $x79)) <= -2.0,
            "e65": -((0.5 * $x80) - (0.125 * $x82)) <= -2.0,
            "e66": -((0.125 * $x80) - (0.5 * $x82)) <= -2.0,
            "e67": -((0.333333 * $x84) - (0.083333 * $x86)) <= -2.0,
            "e68": -((0.088417 * $x84) - (0.314167 * $x86)) <= -2.0,
            "e69": -((0.333333 * $x88) - (0.083333 * $x90)) <= -2.0,
            "e70": -((0.088417 * $x88) - (0.314167 * $x90)) <= -2.0,
            "e71": -((0.666667 * $x92) - (0.166667 * $x94)) <= -2.0,
            "e72": -((0.166667 * $x92) - (0.666667 * $x94)) <= -2.0,
            "e73": -((0.666667 * $x96) - (0.166667 * $x98)) <= -2.0,
            "e74": -((0.166667 * $x96) - (0.666667 * $x98)) <= -2.0,
            "e75": -((0.666667 * $x100) - (0.166667 * $x102)) <= -2.0,
            "e76": -((0.166667 * $x100) - (0.666667 * $x102)) <= -2.0,
