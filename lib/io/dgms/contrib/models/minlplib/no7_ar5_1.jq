...
module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar5_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:no7_ar5_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e47": -((0.559003 * $x66) - (0.111806 * $x69)) <= -2.0,
            "e48": -((0.117096 * $x66) - (0.53375 * $x69)) <= -2.0,
            "e49": -((0.559003 * $x67) - (0.111806 * $x70)) <= -2.0,
            "e50": -((0.117096 * $x67) - (0.53375 * $x70)) <= -2.0,
            "e51": -((0.559003 * $x72) - (0.111806 * $x74)) <= -2.0,
            "e52": -((0.117096 * $x72) - (0.53375 * $x74)) <= -2.0,
            "e53": -((0.361115 * $x76) - (0.076922 * $x77)) <= -2.0,
            "e54": -((0.117096 * $x76) - (0.237222 * $x77)) <= -2.0,
            "e55": -((0.745379 * $x78) - (0.149067 * $x80)) <= -2.0,
            "e56": -((0.149071 * $x78) - (0.745356 * $x80)) <= -2.0,
            "e57": -((0.745379 * $x82) - (0.149067 * $x84)) <= -2.0,
            "e58": -((0.149071 * $x82) - (0.745356 * $x84)) <= -2.0,
            "e59": -((0.745379 * $x86) - (0.149067 * $x87)) <= -2.0,
            "e60": -((0.149071 * $x86) - (0.745356 * $x87)) <= -2.0,
