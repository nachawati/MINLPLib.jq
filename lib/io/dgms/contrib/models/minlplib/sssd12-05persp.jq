...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd12-05persp";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd12-05persp($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e37": -($b74 + $x94) <= 0.0,
            "e38": -($b75 + $x95) <= 0.0,
            "e39": ((($x81 * $b61) + ($x81 * $x76)) - ($x76 * $b61)) <= 0.0,
            "e40": ((($x82 * $b62) + ($x82 * $x76)) - ($x76 * $b62)) <= 0.0,
            "e41": ((($x83 * $b63) + ($x83 * $x76)) - ($x76 * $b63)) <= 0.0,
            "e42": ((($x84 * $b64) + ($x84 * $x77)) - ($x77 * $b64)) <= 0.0,
            "e43": ((($x85 * $b65) + ($x85 * $x77)) - ($x77 * $b65)) <= 0.0,
            "e44": ((($x86 * $b66) + ($x86 * $x77)) - ($x77 * $b66)) <= 0.0,
            "e45": ((($x87 * $b67) + ($x87 * $x78)) - ($x78 * $b67)) <= 0.0,
            "e46": ((($x88 * $b68) + ($x88 * $x78)) - ($x78 * $b68)) <= 0.0,
            "e47": ((($x89 * $b69) + ($x89 * $x78)) - ($x78 * $b69)) <= 0.0,
            "e48": ((($x90 * $b70) + ($x90 * $x79)) - ($x79 * $b70)) <= 0.0,
            "e49": ((($x91 * $b71) + ($x91 * $x79)) - ($x79 * $b71)) <= 0.0,
            "e50": ((($x92 * $b72) + ($x92 * $x79)) - ($x79 * $b72)) <= 0.0,
            "e51": ((($x93 * $b73) + ($x93 * $x80)) - ($x80 * $b73)) <= 0.0,
            "e52": ((($x94 * $b74) + ($x94 * $x80)) - ($x80 * $b74)) <= 0.0,
            "e53": ((($x95 * $b75) + ($x95 * $x80)) - ($x80 * $b75)) <= 0.0
        }
    }
};
