...
module namespace ns = "http://dgms.io/contrib/models/minlplib/fo8_ar2_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:fo8_ar2_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e61": -((0.353557 * $x76) - (0.176775 * $x78)) <= -2.0,
            "e62": -((0.176775 * $x76) - (0.353556 * $x78)) <= -2.0,
            "e63": -((0.353557 * $x77) - (0.176775 * $x79)) <= -2.0,
            "e64": -((0.176775 * $x77) - (0.353556 * $x79)) <= -2.0,
            "e65": -((0.353557 * $x80) - (0.176775 * $x82)) <= -2.0,
            "e66": -((0.176775 * $x80) - (0.353556 * $x82)) <= -2.0,
            "e67": -((0.235705 * $x84) - (0.11785 * $x86)) <= -2.0,
            "e68": -((0.117851 * $x84) - (0.235703 * $x86)) <= -2.0,
            "e69": -((0.235705 * $x88) - (0.11785 * $x90)) <= -2.0,
            "e70": -((0.117851 * $x88) - (0.235703 * $x90)) <= -2.0,
            "e71": -((0.471409 * $x92) - (0.2357 * $x94)) <= -2.0,
            "e72": -((0.235705 * $x92) - (0.4714 * $x94)) <= -2.0,
            "e73": -((0.471409 * $x96) - (0.2357 * $x98)) <= -2.0,
            "e74": -((0.235705 * $x96) - (0.4714 * $x98)) <= -2.0,
            "e75": -((0.471409 * $x100) - (0.2357 * $x102)) <= -2.0,
            "e76": -((0.235705 * $x100) - (0.4714 * $x102)) <= -2.0,
