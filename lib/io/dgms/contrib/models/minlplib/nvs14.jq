...
module namespace ns = "http://dgms.io/contrib/models/minlplib/nvs14";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:nvs14($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    let $x8 := $input.x8
    return {
        "obj": ((((5.3578547 * math:pow($i3, 2.0)) + ((0.8356891 * $i1) * $i5)) + (37.293239 * $i1)) - 40792.141),
        "constraints": {
