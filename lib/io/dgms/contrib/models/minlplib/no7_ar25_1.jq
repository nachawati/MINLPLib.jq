...
module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar25_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:no7_ar25_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e47": -((0.395288 * $x66) - (0.158112 * $x69)) <= -2.0,
            "e48": -((0.158113 * $x66) - (0.395288 * $x69)) <= -2.0,
            "e49": -((0.395288 * $x67) - (0.158112 * $x70)) <= -2.0,
            "e50": -((0.158113 * $x67) - (0.395288 * $x70)) <= -2.0,
            "e51": -((0.395288 * $x72) - (0.158112 * $x74)) <= -2.0,
            "e52": -((0.158113 * $x72) - (0.395288 * $x74)) <= -2.0,
            "e53": -((0.263525 * $x76) - (0.105408 * $x77)) <= -2.0,
            "e54": -((0.117096 * $x76) - (0.237222 * $x77)) <= -2.0,
            "e55": -((0.527037 * $x78) - (0.210822 * $x80)) <= -2.0,
            "e56": -((0.210819 * $x78) - (0.527044 * $x80)) <= -2.0,
            "e57": -((0.527037 * $x82) - (0.210822 * $x84)) <= -2.0,
            "e58": -((0.210819 * $x82) - (0.527044 * $x84)) <= -2.0,
            "e59": -((0.527037 * $x86) - (0.210822 * $x87)) <= -2.0,
            "e60": -((0.210819 * $x86) - (0.527044 * $x87)) <= -2.0,
