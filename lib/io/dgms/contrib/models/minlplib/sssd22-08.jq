...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd22-08";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd22-08($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e62": -($b199 + $x231) <= 0.0,
            "e63": -($b200 + $x232) <= 0.0,
            "e64": -(($x201 idiv (1.0 + $x201)) + $x209) <= 0.0,
            "e65": -(($x201 idiv (1.0 + $x201)) + $x210) <= 0.0,
            "e66": -(($x201 idiv (1.0 + $x201)) + $x211) <= 0.0,
            "e67": -(($x202 idiv (1.0 + $x202)) + $x212) <= 0.0,
            "e68": -(($x202 idiv (1.0 + $x202)) + $x213) <= 0.0,
            "e69": -(($x202 idiv (1.0 + $x202)) + $x214) <= 0.0,
            "e70": -(($x203 idiv (1.0 + $x203)) + $x215) <= 0.0,
            "e71": -(($x203 idiv (1.0 + $x203)) + $x216) <= 0.0,
            "e72": -(($x203 idiv (1.0 + $x203)) + $x217) <= 0.0,
            "e73": -(($x204 idiv (1.0 + $x204)) + $x218) <= 0.0,
            "e74": -(($x204 idiv (1.0 + $x204)) + $x219) <= 0.0,
            "e75": -(($x204 idiv (1.0 + $x204)) + $x220) <= 0.0,
            "e76": -(($x205 idiv (1.0 + $x205)) + $x221) <= 0.0,
            "e77": -(($x205 idiv (1.0 + $x205)) + $x222) <= 0.0,
            "e78": -(($x205 idiv (1.0 + $x205)) + $x223) <= 0.0,
            "e79": -(($x206 idiv (1.0 + $x206)) + $x224) <= 0.0,
            "e80": -(($x206 idiv (1.0 + $x206)) + $x225) <= 0.0,
            "e81": -(($x206 idiv (1.0 + $x206)) + $x226) <= 0.0,
            "e82": -(($x207 idiv (1.0 + $x207)) + $x227) <= 0.0,
            "e83": -(($x207 idiv (1.0 + $x207)) + $x228) <= 0.0,
            "e84": -(($x207 idiv (1.0 + $x207)) + $x229) <= 0.0,
            "e85": -(($x208 idiv (1.0 + $x208)) + $x230) <= 0.0,
            "e86": -(($x208 idiv (1.0 + $x208)) + $x231) <= 0.0,
            "e87": -(($x208 idiv (1.0 + $x208)) + $x232) <= 0.0
        }
    }
};
