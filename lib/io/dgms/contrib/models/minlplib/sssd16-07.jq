...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd16-07";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd16-07($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e51": -($b132 + $x160) <= 0.0,
            "e52": -($b133 + $x161) <= 0.0,
            "e53": -(($x134 idiv (1.0 + $x134)) + $x141) <= 0.0,
            "e54": -(($x134 idiv (1.0 + $x134)) + $x142) <= 0.0,
            "e55": -(($x134 idiv (1.0 + $x134)) + $x143) <= 0.0,
            "e56": -(($x135 idiv (1.0 + $x135)) + $x144) <= 0.0,
            "e57": -(($x135 idiv (1.0 + $x135)) + $x145) <= 0.0,
            "e58": -(($x135 idiv (1.0 + $x135)) + $x146) <= 0.0,
            "e59": -(($x136 idiv (1.0 + $x136)) + $x147) <= 0.0,
            "e60": -(($x136 idiv (1.0 + $x136)) + $x148) <= 0.0,
            "e61": -(($x136 idiv (1.0 + $x136)) + $x149) <= 0.0,
            "e62": -(($x137 idiv (1.0 + $x137)) + $x150) <= 0.0,
            "e63": -(($x137 idiv (1.0 + $x137)) + $x151) <= 0.0,
            "e64": -(($x137 idiv (1.0 + $x137)) + $x152) <= 0.0,
            "e65": -(($x138 idiv (1.0 + $x138)) + $x153) <= 0.0,
            "e66": -(($x138 idiv (1.0 + $x138)) + $x154) <= 0.0,
            "e67": -(($x138 idiv (1.0 + $x138)) + $x155) <= 0.0,
            "e68": -(($x139 idiv (1.0 + $x139)) + $x156) <= 0.0,
            "e69": -(($x139 idiv (1.0 + $x139)) + $x157) <= 0.0,
            "e70": -(($x139 idiv (1.0 + $x139)) + $x158) <= 0.0,
            "e71": -(($x140 idiv (1.0 + $x140)) + $x159) <= 0.0,
            "e72": -(($x140 idiv (1.0 + $x140)) + $x160) <= 0.0,
            "e73": -(($x140 idiv (1.0 + $x140)) + $x161) <= 0.0
        }
    }
};
