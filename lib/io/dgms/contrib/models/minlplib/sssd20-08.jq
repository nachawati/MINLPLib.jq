...
module namespace ns = "http://dgms.io/contrib/models/minlplib/sssd20-08";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:sssd20-08($input)
{
    let $b1 := $input.b1
    let $b2 := $input.b2
    let $b3 := $input.b3
    ...
    return {
        ...
        "constraints": {
            ...
            "e60": -($b183 + $x215) <= 0.0,
            "e61": -($b184 + $x216) <= 0.0,
            "e62": -(($x185 idiv (1.0 + $x185)) + $x193) <= 0.0,
            "e63": -(($x185 idiv (1.0 + $x185)) + $x194) <= 0.0,
            "e64": -(($x185 idiv (1.0 + $x185)) + $x195) <= 0.0,
            "e65": -(($x186 idiv (1.0 + $x186)) + $x196) <= 0.0,
            "e66": -(($x186 idiv (1.0 + $x186)) + $x197) <= 0.0,
            "e67": -(($x186 idiv (1.0 + $x186)) + $x198) <= 0.0,
            "e68": -(($x187 idiv (1.0 + $x187)) + $x199) <= 0.0,
            "e69": -(($x187 idiv (1.0 + $x187)) + $x200) <= 0.0,
            "e70": -(($x187 idiv (1.0 + $x187)) + $x201) <= 0.0,
            "e71": -(($x188 idiv (1.0 + $x188)) + $x202) <= 0.0,
            "e72": -(($x188 idiv (1.0 + $x188)) + $x203) <= 0.0,
            "e73": -(($x188 idiv (1.0 + $x188)) + $x204) <= 0.0,
            "e74": -(($x189 idiv (1.0 + $x189)) + $x205) <= 0.0,
            "e75": -(($x189 idiv (1.0 + $x189)) + $x206) <= 0.0,
            "e76": -(($x189 idiv (1.0 + $x189)) + $x207) <= 0.0,
            "e77": -(($x190 idiv (1.0 + $x190)) + $x208) <= 0.0,
            "e78": -(($x190 idiv (1.0 + $x190)) + $x209) <= 0.0,
            "e79": -(($x190 idiv (1.0 + $x190)) + $x210) <= 0.0,
            "e80": -(($x191 idiv (1.0 + $x191)) + $x211) <= 0.0,
            "e81": -(($x191 idiv (1.0 + $x191)) + $x212) <= 0.0,
            "e82": -(($x191 idiv (1.0 + $x191)) + $x213) <= 0.0,
            "e83": -(($x192 idiv (1.0 + $x192)) + $x214) <= 0.0,
            "e84": -(($x192 idiv (1.0 + $x192)) + $x215) <= 0.0,
            "e85": -(($x192 idiv (1.0 + $x192)) + $x216) <= 0.0
        }
    }
};
