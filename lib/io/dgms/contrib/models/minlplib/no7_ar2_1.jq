...
module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar2_1";

import module namespace math = "http://www.w3.org/2005/xpath-functions/math";

declare function ns:no7_ar2_1($input)
{
    let $i1 := $input.i1
    let $i2 := $input.i2
    let $i3 := $input.i3
    ...
    return {
        ...
        "constraints": {
            ...
            "e47": -((0.353557 * $x66) - (0.176775 * $x69)) <= -2.0,
            "e48": -((0.176775 * $x66) - (0.353556 * $x69)) <= -2.0,
            "e49": -((0.353557 * $x67) - (0.176775 * $x70)) <= -2.0,
            "e50": -((0.176775 * $x67) - (0.353556 * $x70)) <= -2.0,
            "e51": -((0.353557 * $x72) - (0.176775 * $x74)) <= -2.0,
            "e52": -((0.176775 * $x72) - (0.353556 * $x74)) <= -2.0,
            "e53": -((0.235705 * $x76) - (0.11785 * $x77)) <= -2.0,
            "e54": -((0.117851 * $x76) - (0.235703 * $x77)) <= -2.0,
            "e55": -((0.471409 * $x78) - (0.2357 * $x80)) <= -2.0,
            "e56": -((0.235705 * $x78) - (0.4714 * $x80)) <= -2.0,
            "e57": -((0.471409 * $x82) - (0.2357 * $x84)) <= -2.0,
            "e58": -((0.235705 * $x82) - (0.4714 * $x84)) <= -2.0,
            "e59": -((0.471409 * $x86) - (0.2357 * $x87)) <= -2.0,
            "e60": -((0.235705 * $x86) - (0.4714 * $x87)) <= -2.0,
