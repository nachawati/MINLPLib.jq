...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/rsyn0810m02h";
...
let $input := {
    ...
    "x618": a:variable({ name: "x618", bounds: [0.0, 40.0] }),
    "x619": a:variable({ name: "x619", bounds: [0.0, 40.0] }),
    ...
    "x640": a:variable({ name: "x640", bounds: [0.0, 30.0] }),
    "x641": a:variable({ name: "x641", bounds: [0.0, 30.0] }),
