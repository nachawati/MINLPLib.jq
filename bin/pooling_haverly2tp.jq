...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/pooling_haverly2tp";
...
let $input := {
    ...
    "x8": a:variable({ name: "x8", bounds: [0.0, 800.0] }),
    "x9": a:variable({ name: "x9", bounds: [0.0, 800.0] }),
    "x10": a:variable({ name: "x10", bounds: [0.0, 600.0] }),
    "x11": a:variable({ name: "x11", bounds: [0.0, 200.0] })
} return {
    "obj": a:minimize({
        model: ns:pooling_haverly2tp#1,
        input: $input,
