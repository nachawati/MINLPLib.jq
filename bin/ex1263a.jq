...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex1263a";
...
let $input := {
    ...
    "i21": a:variable({ name: "i21", domain: "integer", bounds: [0.0, 30.0] }),
    "i22": a:variable({ name: "i22", domain: "integer", bounds: [0.0, 30.0] }),
    "i23": a:variable({ name: "i23", domain: "integer", bounds: [0.0, 30.0] }),
    "i24": a:variable({ name: "i24", domain: "integer", bounds: [0.0, 30.0] })
} return {
    "obj": a:minimize({
        model: ns:ex1263a#1,
        input: $input,
