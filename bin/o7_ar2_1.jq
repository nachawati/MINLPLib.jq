...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o7_ar2_1";
...
let $input := {
    ...
    "x68": a:variable({ name: "x68", bounds: [2.8284, 5.6569] }),
    "x69": a:variable({ name: "x69", bounds: [2.8284, 5.6569] }),
    "x70": a:variable({ name: "x70" }),
    "x71": a:variable({ name: "x71", bounds: [2.8284, 5.6569] }),
    ...
    "x78": a:variable({ name: "x78", bounds: [4.2426, 8.4853] }),
    "x79": a:variable({ name: "x79", bounds: [4.2426, 8.4853] }),
    ...
    "x88": a:variable({ name: "x88", bounds: [2.1213, 4.2426] }),
    "x89": a:variable({ name: "x89", bounds: [2.1213, 4.2426] }),
