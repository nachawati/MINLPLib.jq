...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/st_test3";
...
let $input := {
    ...
    "i10": a:variable({ name: "i10", domain: "integer", bounds: [0.0, 1.0E15] }),
    "i11": a:variable({ name: "i11", domain: "integer", bounds: [0.0, 1.0E15] }),
    "i12": a:variable({ name: "i12", domain: "integer", bounds: [0.0, 1.0E15] }),
    "i13": a:variable({ name: "i13", domain: "integer", bounds: [0.0, 1.0] })
} return {
    "obj": a:minimize({
        model: ns:st_test3#1,
        input: $input,
