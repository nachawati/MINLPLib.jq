...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/nvs24";
...
let $input := {
    ...
    "i8": a:variable({ name: "i8", domain: "integer", bounds: [0.0, 200.0] }),
    "i9": a:variable({ name: "i9", domain: "integer", bounds: [0.0, 200.0] }),
    "i10": a:variable({ name: "i10", domain: "integer", bounds: [0.0, 200.0] })
} return {
    "obj": a:minimize({
        model: ns:nvs24#1,
        input: $input,
