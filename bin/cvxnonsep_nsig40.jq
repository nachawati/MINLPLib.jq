...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/cvxnonsep_nsig40";
...
let $input := {
    ...
    "x31": a:variable({ name: "x31", bounds: [1.0E-5, 10.0] }),
    "x32": a:variable({ name: "x32", bounds: [1.0E-5, 10.0] }),
    "x33": a:variable({ name: "x33", bounds: [1.0E-5, 10.0] }),
    "x34": a:variable({ name: "x34", bounds: [1.0E-5, 10.0] }),
    "x35": a:variable({ name: "x35", bounds: [1.0E-5, 10.0] }),
    "x36": a:variable({ name: "x36", bounds: [1.0E-5, 10.0] }),
    "x37": a:variable({ name: "x37", bounds: [1.0E-5, 10.0] }),
    "x38": a:variable({ name: "x38", bounds: [1.0E-5, 10.0] }),
    "x39": a:variable({ name: "x39", bounds: [1.0E-5, 10.0] }),
    "x40": a:variable({ name: "x40", bounds: [1.0E-5, 10.0] })
} return {
    "obj": a:minimize({
        model: ns:cvxnonsep_nsig40#1,
        input: $input,
