...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/lnts100";
...
let $input := {
    ...
    "x303": a:variable({ name: "x303", bounds: [5.0, 5.0] }),
    ...
    "x404": a:variable({ name: "x404", bounds: [45.0, 45.0] }),
