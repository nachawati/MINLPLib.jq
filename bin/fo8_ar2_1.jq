...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo8_ar2_1";
...
let $input := {
    ...
    "x76": a:variable({ name: "x76", bounds: [2.8284, 5.6569] }),
    "x77": a:variable({ name: "x77", bounds: [2.8284, 5.6569] }),
    "x78": a:variable({ name: "x78", bounds: [2.8284, 5.6569] }),
    "x79": a:variable({ name: "x79", bounds: [2.8284, 5.6569] }),
    "x80": a:variable({ name: "x80", bounds: [2.8284, 5.6569] }),
    "x81": a:variable({ name: "x81" }),
    "x82": a:variable({ name: "x82", bounds: [2.8284, 5.6569] }),
    "x83": a:variable({ name: "x83" }),
    "x84": a:variable({ name: "x84", bounds: [4.2426, 8.4853] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [4.2426, 8.4853] }),
    "x87": a:variable({ name: "x87" }),
    "x88": a:variable({ name: "x88", bounds: [4.2426, 8.4853] }),
    "x89": a:variable({ name: "x89" }),
    "x90": a:variable({ name: "x90", bounds: [4.2426, 8.4853] }),
    "x91": a:variable({ name: "x91" }),
    "x92": a:variable({ name: "x92", bounds: [2.1213, 4.2426] }),
    "x93": a:variable({ name: "x93" }),
    "x94": a:variable({ name: "x94", bounds: [2.1213, 4.2426] }),
    "x95": a:variable({ name: "x95" }),
    "x96": a:variable({ name: "x96", bounds: [2.1213, 4.2426] }),
    "x97": a:variable({ name: "x97" }),
    "x98": a:variable({ name: "x98", bounds: [2.1213, 4.2426] }),
    "x99": a:variable({ name: "x99" }),
    "x100": a:variable({ name: "x100", bounds: [2.1213, 4.2426] }),
    "x101": a:variable({ name: "x101" }),
    "x102": a:variable({ name: "x102", bounds: [2.1213, 4.2426] }),
