...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_congruentcircles_c52";
...
let $input := {
    ...
    "x13": a:variable({ name: "x13", bounds: [0.0, 2.0] }),
    "x14": a:variable({ name: "x14", bounds: [0.0, 8.0] })
} return {
    "obj": a:minimize({
        model: ns:kall_congruentcircles_c52#1,
        input: $input,
