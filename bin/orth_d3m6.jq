...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/orth_d3m6";
...
let $input := {
    ...
    "x12": a:variable({ name: "x12", bounds: [-1.0, 1.0] }),
    ...
    "x19": a:variable({ name: "x19", bounds: [-1.0, 1.0] }),
