...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/lnts50";
...
let $input := {
    ...
    "x103": a:variable({ name: "x103", bounds: [0.0, 0.0] }),
    ...
    "x153": a:variable({ name: "x153", bounds: [5.0, 5.0] }),
    ...
    "x204": a:variable({ name: "x204", bounds: [45.0, 45.0] }),
