...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/rsyn0805m02h";
...
let $input := {
    ...
    "x608": a:variable({ name: "x608", bounds: [0.0, 40.0] }),
    "x609": a:variable({ name: "x609", bounds: [0.0, 40.0] }),
    ...
    "x630": a:variable({ name: "x630", bounds: [0.0, 30.0] }),
    "x631": a:variable({ name: "x631", bounds: [0.0, 30.0] }),
