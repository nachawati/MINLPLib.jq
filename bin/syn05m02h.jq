...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn05m02h";
...
let $input := {
    ...
    "x12": a:variable({ name: "x12", bounds: [0.0, 40.0] }),
    "x13": a:variable({ name: "x13", bounds: [0.0, 40.0] }),
