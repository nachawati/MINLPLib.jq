...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_20_2";
...
let $input := {
    ...
    "x197": a:variable({ name: "x197", bounds: [0.599362, 9.400638] }),
    "x198": a:variable({ name: "x198", bounds: [0.599362, 9.400638] }),
    "x199": a:variable({ name: "x199", bounds: [0.599362, 9.400638] }),
    "x200": a:variable({ name: "x200", bounds: [0.599362, 9.400638] }),
    "x201": a:variable({ name: "x201", bounds: [0.599362, 9.400638] }),
    "x202": a:variable({ name: "x202", bounds: [0.599362, 9.400638] }),
    "x203": a:variable({ name: "x203", bounds: [0.599362, 9.400638] }),
    "x204": a:variable({ name: "x204", bounds: [0.599362, 9.400638] }),
    "x205": a:variable({ name: "x205", bounds: [0.599362, 9.400638] }),
    "x206": a:variable({ name: "x206", bounds: [0.599362, 9.400638] }),
    "x207": a:variable({ name: "x207", bounds: [0.599362, 9.400638] }),
    "x208": a:variable({ name: "x208", bounds: [0.599362, 9.400638] }),
    "x209": a:variable({ name: "x209", bounds: [0.342553, 9.657447] }),
    "x210": a:variable({ name: "x210", bounds: [0.342553, 9.657447] }),
    "x211": a:variable({ name: "x211", bounds: [0.342553, 9.657447] }),
    "x212": a:variable({ name: "x212", bounds: [0.342553, 9.657447] }),
    "x213": a:variable({ name: "x213", bounds: [0.342553, 9.657447] }),
    "x214": a:variable({ name: "x214", bounds: [0.342553, 9.657447] }),
    "x215": a:variable({ name: "x215", bounds: [0.342553, 9.657447] }),
    "x216": a:variable({ name: "x216", bounds: [0.342553, 9.657447] }),
    "x217": a:variable({ name: "x217", bounds: [0.342553, 9.657447] }),
    "x218": a:variable({ name: "x218", bounds: [0.342553, 9.657447] }),
    "x219": a:variable({ name: "x219", bounds: [0.85617, 9.14383] }),
    "x220": a:variable({ name: "x220", bounds: [0.85617, 9.14383] }),
    "x221": a:variable({ name: "x221", bounds: [0.85617, 9.14383] }),
    "x222": a:variable({ name: "x222", bounds: [0.85617, 9.14383] }),
    "x223": a:variable({ name: "x223", bounds: [0.85617, 9.14383] }),
    "x224": a:variable({ name: "x224", bounds: [0.85617, 9.14383] }),
    "x225": a:variable({ name: "x225", bounds: [0.85617, 9.14383] }),
    "x226": a:variable({ name: "x226", bounds: [0.85617, 9.14383] }),
    "x227": a:variable({ name: "x227", bounds: [1.52426, 8.47574] }),
    "x228": a:variable({ name: "x228", bounds: [1.52426, 8.47574] }),
    "x229": a:variable({ name: "x229", bounds: [1.52426, 8.47574] }),
    "x230": a:variable({ name: "x230", bounds: [1.52426, 8.47574] }),
    "x231": a:variable({ name: "x231", bounds: [1.52426, 8.47574] }),
    "x232": a:variable({ name: "x232", bounds: [1.52426, 8.47574] }),
    "x233": a:variable({ name: "x233", bounds: [1.93213, 8.06787] }),
    "x234": a:variable({ name: "x234", bounds: [1.93213, 8.06787] }),
    "x235": a:variable({ name: "x235", bounds: [1.93213, 8.06787] }),
    "x236": a:variable({ name: "x236", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_20_2#1,
        input: $input,
