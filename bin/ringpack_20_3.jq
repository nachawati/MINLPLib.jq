...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_20_3";
...
let $input := {
    ...
    "x215": a:variable({ name: "x215", bounds: [0.599362, 9.400638] }),
    "x216": a:variable({ name: "x216", bounds: [0.599362, 9.400638] }),
    "x217": a:variable({ name: "x217", bounds: [0.599362, 9.400638] }),
    "x218": a:variable({ name: "x218", bounds: [0.599362, 9.400638] }),
    "x219": a:variable({ name: "x219", bounds: [0.599362, 9.400638] }),
    "x220": a:variable({ name: "x220", bounds: [0.599362, 9.400638] }),
    "x221": a:variable({ name: "x221", bounds: [0.599362, 9.400638] }),
    "x222": a:variable({ name: "x222", bounds: [0.599362, 9.400638] }),
    "x223": a:variable({ name: "x223", bounds: [0.599362, 9.400638] }),
    "x224": a:variable({ name: "x224", bounds: [0.599362, 9.400638] }),
    "x225": a:variable({ name: "x225", bounds: [0.599362, 9.400638] }),
    "x226": a:variable({ name: "x226", bounds: [0.599362, 9.400638] }),
    "x227": a:variable({ name: "x227", bounds: [0.342553, 9.657447] }),
    "x228": a:variable({ name: "x228", bounds: [0.342553, 9.657447] }),
    "x229": a:variable({ name: "x229", bounds: [0.342553, 9.657447] }),
    "x230": a:variable({ name: "x230", bounds: [0.342553, 9.657447] }),
    "x231": a:variable({ name: "x231", bounds: [0.342553, 9.657447] }),
    "x232": a:variable({ name: "x232", bounds: [0.342553, 9.657447] }),
    "x233": a:variable({ name: "x233", bounds: [0.342553, 9.657447] }),
    "x234": a:variable({ name: "x234", bounds: [0.342553, 9.657447] }),
    "x235": a:variable({ name: "x235", bounds: [0.342553, 9.657447] }),
    "x236": a:variable({ name: "x236", bounds: [0.342553, 9.657447] }),
    "x237": a:variable({ name: "x237", bounds: [0.85617, 9.14383] }),
    "x238": a:variable({ name: "x238", bounds: [0.85617, 9.14383] }),
    "x239": a:variable({ name: "x239", bounds: [0.85617, 9.14383] }),
    "x240": a:variable({ name: "x240", bounds: [0.85617, 9.14383] }),
    "x241": a:variable({ name: "x241", bounds: [0.85617, 9.14383] }),
    "x242": a:variable({ name: "x242", bounds: [0.85617, 9.14383] }),
    "x243": a:variable({ name: "x243", bounds: [0.85617, 9.14383] }),
    "x244": a:variable({ name: "x244", bounds: [0.85617, 9.14383] }),
    "x245": a:variable({ name: "x245", bounds: [0.85617, 9.14383] }),
    "x246": a:variable({ name: "x246", bounds: [0.85617, 9.14383] }),
    "x247": a:variable({ name: "x247", bounds: [1.52426, 8.47574] }),
    "x248": a:variable({ name: "x248", bounds: [1.52426, 8.47574] }),
    "x249": a:variable({ name: "x249", bounds: [1.52426, 8.47574] }),
    "x250": a:variable({ name: "x250", bounds: [1.52426, 8.47574] }),
    "x251": a:variable({ name: "x251", bounds: [1.93213, 8.06787] }),
    "x252": a:variable({ name: "x252", bounds: [1.93213, 8.06787] }),
    "x253": a:variable({ name: "x253", bounds: [1.93213, 8.06787] }),
    "x254": a:variable({ name: "x254", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_20_3#1,
        input: $input,
