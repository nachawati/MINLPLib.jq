...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex4";
...
let $input := {
    ...
    "x26": a:variable({ name: "x26", bounds: [2.0, 4.5] }),
    "x27": a:variable({ name: "x27", bounds: [0.0, 8.0] }),
    "x28": a:variable({ name: "x28", bounds: [3.0, 9.0] }),
    "x29": a:variable({ name: "x29", bounds: [0.0, 5.0] }),
    "x30": a:variable({ name: "x30", bounds: [4.0, 10.0] }),
