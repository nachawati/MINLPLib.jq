...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex8_6_1";
...
let $input := {
    ...
    "x6": a:variable({ name: "x6", bounds: [-5.0, 5.0] }),
    "x7": a:variable({ name: "x7", bounds: [-5.0, 5.0] }),
    "x8": a:variable({ name: "x8", bounds: [-5.0, 5.0] }),
    "x9": a:variable({ name: "x9", bounds: [-5.0, 5.0] }),
    "x10": a:variable({ name: "x10", bounds: [-5.0, 5.0] }),
    "x11": a:variable({ name: "x11", bounds: [0.0, 0.0] }),
    "x12": a:variable({ name: "x12", bounds: [0.0, 0.0] }),
    "x13": a:variable({ name: "x13", bounds: [-5.0, 5.0] }),
    "x14": a:variable({ name: "x14", bounds: [-5.0, 5.0] }),
    "x15": a:variable({ name: "x15", bounds: [-5.0, 5.0] }),
    "x16": a:variable({ name: "x16", bounds: [-5.0, 5.0] }),
    "x17": a:variable({ name: "x17", bounds: [-5.0, 5.0] }),
    "x18": a:variable({ name: "x18", bounds: [-5.0, 5.0] }),
    "x19": a:variable({ name: "x19", bounds: [-5.0, 5.0] }),
    "x20": a:variable({ name: "x20", bounds: [-5.0, 5.0] }),
    "x21": a:variable({ name: "x21", bounds: [0.0, 0.0] }),
    "x22": a:variable({ name: "x22", bounds: [0.0, 0.0] }),
    "x23": a:variable({ name: "x23", bounds: [0.0, 0.0] }),
    "x24": a:variable({ name: "x24", bounds: [-5.0, 5.0] }),
    "x25": a:variable({ name: "x25", bounds: [-5.0, 5.0] }),
    "x26": a:variable({ name: "x26", bounds: [-5.0, 5.0] }),
    "x27": a:variable({ name: "x27", bounds: [-5.0, 5.0] }),
    "x28": a:variable({ name: "x28", bounds: [-5.0, 5.0] }),
    "x29": a:variable({ name: "x29", bounds: [-5.0, 5.0] }),
    "x30": a:variable({ name: "x30", bounds: [-5.0, 5.0] }),
