...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_20_1";
...
let $input := {
    ...
    "x177": a:variable({ name: "x177", bounds: [0.599362, 9.400638] }),
    "x178": a:variable({ name: "x178", bounds: [0.599362, 9.400638] }),
    "x179": a:variable({ name: "x179", bounds: [0.599362, 9.400638] }),
    "x180": a:variable({ name: "x180", bounds: [0.599362, 9.400638] }),
    "x181": a:variable({ name: "x181", bounds: [0.599362, 9.400638] }),
    "x182": a:variable({ name: "x182", bounds: [0.599362, 9.400638] }),
    "x183": a:variable({ name: "x183", bounds: [0.599362, 9.400638] }),
    "x184": a:variable({ name: "x184", bounds: [0.599362, 9.400638] }),
    "x185": a:variable({ name: "x185", bounds: [0.599362, 9.400638] }),
    "x186": a:variable({ name: "x186", bounds: [0.599362, 9.400638] }),
    "x187": a:variable({ name: "x187", bounds: [0.599362, 9.400638] }),
    "x188": a:variable({ name: "x188", bounds: [0.599362, 9.400638] }),
    "x189": a:variable({ name: "x189", bounds: [0.342553, 9.657447] }),
    "x190": a:variable({ name: "x190", bounds: [0.342553, 9.657447] }),
    "x191": a:variable({ name: "x191", bounds: [0.342553, 9.657447] }),
    "x192": a:variable({ name: "x192", bounds: [0.342553, 9.657447] }),
    "x193": a:variable({ name: "x193", bounds: [0.342553, 9.657447] }),
    "x194": a:variable({ name: "x194", bounds: [0.342553, 9.657447] }),
    "x195": a:variable({ name: "x195", bounds: [0.342553, 9.657447] }),
    "x196": a:variable({ name: "x196", bounds: [0.342553, 9.657447] }),
    "x197": a:variable({ name: "x197", bounds: [0.342553, 9.657447] }),
    "x198": a:variable({ name: "x198", bounds: [0.342553, 9.657447] }),
    "x199": a:variable({ name: "x199", bounds: [0.85617, 9.14383] }),
    "x200": a:variable({ name: "x200", bounds: [0.85617, 9.14383] }),
    "x201": a:variable({ name: "x201", bounds: [0.85617, 9.14383] }),
    "x202": a:variable({ name: "x202", bounds: [0.85617, 9.14383] }),
    "x203": a:variable({ name: "x203", bounds: [0.85617, 9.14383] }),
    "x204": a:variable({ name: "x204", bounds: [0.85617, 9.14383] }),
    "x205": a:variable({ name: "x205", bounds: [0.85617, 9.14383] }),
    "x206": a:variable({ name: "x206", bounds: [0.85617, 9.14383] }),
    "x207": a:variable({ name: "x207", bounds: [1.52426, 8.47574] }),
    "x208": a:variable({ name: "x208", bounds: [1.52426, 8.47574] }),
    "x209": a:variable({ name: "x209", bounds: [1.52426, 8.47574] }),
    "x210": a:variable({ name: "x210", bounds: [1.52426, 8.47574] }),
    "x211": a:variable({ name: "x211", bounds: [1.52426, 8.47574] }),
    "x212": a:variable({ name: "x212", bounds: [1.52426, 8.47574] }),
    "x213": a:variable({ name: "x213", bounds: [1.93213, 8.06787] }),
    "x214": a:variable({ name: "x214", bounds: [1.93213, 8.06787] }),
    "x215": a:variable({ name: "x215", bounds: [1.93213, 8.06787] }),
    "x216": a:variable({ name: "x216", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_20_1#1,
        input: $input,
