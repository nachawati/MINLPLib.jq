...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar4_1";
...
let $input := {
    ...
    "x66": a:variable({ name: "x66", bounds: [2.0, 8.0] }),
    "x67": a:variable({ name: "x67", bounds: [2.0, 8.0] }),
    "x68": a:variable({ name: "x68" }),
    "x69": a:variable({ name: "x69", bounds: [2.0, 8.0] }),
    "x70": a:variable({ name: "x70", bounds: [2.0, 8.0] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [2.0, 8.0] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [2.0, 8.0] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [3.0, 8.54] }),
    "x77": a:variable({ name: "x77", bounds: [4.2155, 12.0] }),
    "x78": a:variable({ name: "x78", bounds: [1.5, 6.0] }),
    "x79": a:variable({ name: "x79" }),
    "x80": a:variable({ name: "x80", bounds: [1.5, 6.0] }),
    "x81": a:variable({ name: "x81" }),
    "x82": a:variable({ name: "x82", bounds: [1.5, 6.0] }),
    "x83": a:variable({ name: "x83" }),
    "x84": a:variable({ name: "x84", bounds: [1.5, 6.0] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [1.5, 6.0] }),
    "x87": a:variable({ name: "x87", bounds: [1.5, 6.0] }),
