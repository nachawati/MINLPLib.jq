...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/supplychain";
...
let $input := {
    ...
    "x19": a:variable({ name: "x19", bounds: [0.0, 28.2665880502051] }),
    "x20": a:variable({ name: "x20", bounds: [0.0, 28.2665880502051] }),
    "x21": a:variable({ name: "x21", bounds: [0.0, 28.2665880502051] }),
    "x22": a:variable({ name: "x22", bounds: [0.0, 349.499642346026] }),
    "x23": a:variable({ name: "x23", bounds: [0.0, 349.499642346026] }),
    "x24": a:variable({ name: "x24", bounds: [0.0, 349.499642346026] }),
