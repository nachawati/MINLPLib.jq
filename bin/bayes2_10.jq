...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/bayes2_10";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [0.0, null] }),
    "x2": a:variable({ name: "x2", bounds: [0.0, 10000.0] }),
    ...
    "x11": a:variable({ name: "x11", bounds: [0.0, 10000.0] }),
