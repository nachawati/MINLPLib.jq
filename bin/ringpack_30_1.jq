...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_30_1";
...
let $input := {
    ...
    "x375": a:variable({ name: "x375", bounds: [0.599362, 9.400638] }),
    "x376": a:variable({ name: "x376", bounds: [0.599362, 9.400638] }),
    "x377": a:variable({ name: "x377", bounds: [0.599362, 9.400638] }),
    "x378": a:variable({ name: "x378", bounds: [0.599362, 9.400638] }),
    "x379": a:variable({ name: "x379", bounds: [0.599362, 9.400638] }),
    "x380": a:variable({ name: "x380", bounds: [0.599362, 9.400638] }),
    "x381": a:variable({ name: "x381", bounds: [0.599362, 9.400638] }),
    "x382": a:variable({ name: "x382", bounds: [0.599362, 9.400638] }),
    "x383": a:variable({ name: "x383", bounds: [0.599362, 9.400638] }),
    "x384": a:variable({ name: "x384", bounds: [0.599362, 9.400638] }),
    "x385": a:variable({ name: "x385", bounds: [0.599362, 9.400638] }),
    "x386": a:variable({ name: "x386", bounds: [0.599362, 9.400638] }),
    "x387": a:variable({ name: "x387", bounds: [0.599362, 9.400638] }),
    "x388": a:variable({ name: "x388", bounds: [0.599362, 9.400638] }),
    "x389": a:variable({ name: "x389", bounds: [0.599362, 9.400638] }),
    "x390": a:variable({ name: "x390", bounds: [0.599362, 9.400638] }),
    "x391": a:variable({ name: "x391", bounds: [0.599362, 9.400638] }),
    "x392": a:variable({ name: "x392", bounds: [0.599362, 9.400638] }),
    "x393": a:variable({ name: "x393", bounds: [0.599362, 9.400638] }),
    "x394": a:variable({ name: "x394", bounds: [0.599362, 9.400638] }),
    "x395": a:variable({ name: "x395", bounds: [0.342553, 9.657447] }),
    "x396": a:variable({ name: "x396", bounds: [0.342553, 9.657447] }),
    "x397": a:variable({ name: "x397", bounds: [0.342553, 9.657447] }),
    "x398": a:variable({ name: "x398", bounds: [0.342553, 9.657447] }),
    "x399": a:variable({ name: "x399", bounds: [0.342553, 9.657447] }),
    "x400": a:variable({ name: "x400", bounds: [0.342553, 9.657447] }),
    "x401": a:variable({ name: "x401", bounds: [0.342553, 9.657447] }),
    "x402": a:variable({ name: "x402", bounds: [0.342553, 9.657447] }),
    "x403": a:variable({ name: "x403", bounds: [0.342553, 9.657447] }),
    "x404": a:variable({ name: "x404", bounds: [0.342553, 9.657447] }),
    "x405": a:variable({ name: "x405", bounds: [0.342553, 9.657447] }),
    "x406": a:variable({ name: "x406", bounds: [0.342553, 9.657447] }),
    "x407": a:variable({ name: "x407", bounds: [0.342553, 9.657447] }),
    "x408": a:variable({ name: "x408", bounds: [0.342553, 9.657447] }),
    "x409": a:variable({ name: "x409", bounds: [0.342553, 9.657447] }),
    "x410": a:variable({ name: "x410", bounds: [0.342553, 9.657447] }),
    "x411": a:variable({ name: "x411", bounds: [0.85617, 9.14383] }),
    "x412": a:variable({ name: "x412", bounds: [0.85617, 9.14383] }),
    "x413": a:variable({ name: "x413", bounds: [0.85617, 9.14383] }),
    "x414": a:variable({ name: "x414", bounds: [0.85617, 9.14383] }),
    "x415": a:variable({ name: "x415", bounds: [0.85617, 9.14383] }),
    "x416": a:variable({ name: "x416", bounds: [0.85617, 9.14383] }),
    "x417": a:variable({ name: "x417", bounds: [0.85617, 9.14383] }),
    "x418": a:variable({ name: "x418", bounds: [0.85617, 9.14383] }),
    "x419": a:variable({ name: "x419", bounds: [0.85617, 9.14383] }),
    "x420": a:variable({ name: "x420", bounds: [0.85617, 9.14383] }),
    "x421": a:variable({ name: "x421", bounds: [1.52426, 8.47574] }),
    "x422": a:variable({ name: "x422", bounds: [1.52426, 8.47574] }),
    "x423": a:variable({ name: "x423", bounds: [1.52426, 8.47574] }),
    "x424": a:variable({ name: "x424", bounds: [1.52426, 8.47574] }),
    "x425": a:variable({ name: "x425", bounds: [1.52426, 8.47574] }),
    "x426": a:variable({ name: "x426", bounds: [1.52426, 8.47574] }),
    "x427": a:variable({ name: "x427", bounds: [1.52426, 8.47574] }),
    "x428": a:variable({ name: "x428", bounds: [1.52426, 8.47574] }),
    "x429": a:variable({ name: "x429", bounds: [1.93213, 8.06787] }),
    "x430": a:variable({ name: "x430", bounds: [1.93213, 8.06787] }),
    "x431": a:variable({ name: "x431", bounds: [1.93213, 8.06787] }),
    "x432": a:variable({ name: "x432", bounds: [1.93213, 8.06787] }),
    "x433": a:variable({ name: "x433", bounds: [1.93213, 8.06787] }),
    "x434": a:variable({ name: "x434", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_30_1#1,
        input: $input,
