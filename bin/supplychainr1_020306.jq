...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/supplychainr1_020306";
...
let $input := {
    ...
    "x31": a:variable({ name: "x31", bounds: [1.0, 14.0] }),
    "x32": a:variable({ name: "x32", bounds: [2.0, 14.0] }),
    "x33": a:variable({ name: "x33", bounds: [1.0, 14.0] }),
    "x34": a:variable({ name: "x34", bounds: [1.0, 13.0] }),
    "x35": a:variable({ name: "x35", bounds: [1.0, 14.0] }),
    "x36": a:variable({ name: "x36", bounds: [2.0, 15.0] }),
    ...
    "x47": a:variable({ name: "x47", bounds: [0.0, 40007.5009381706] }),
    "x48": a:variable({ name: "x48", bounds: [0.0, 48009.0011258047] }),
    "x49": a:variable({ name: "x49", bounds: [0.0, 44008.2510319877] }),
    ...
    "x56": a:variable({ name: "x56", bounds: [0.0, 12.0] }),
    "x57": a:variable({ name: "x57", bounds: [0.0, 12.0] }),
    "x58": a:variable({ name: "x58", bounds: [0.0, 12.0] }),
    "x59": a:variable({ name: "x59", bounds: [0.0, 12.0] }),
    "x60": a:variable({ name: "x60", bounds: [0.0, 12.0] }),
    "x61": a:variable({ name: "x61", bounds: [0.0, 12.0] }),
    "x62": a:variable({ name: "x62", bounds: [0.0, 11.0] }),
    "x63": a:variable({ name: "x63", bounds: [0.0, 11.0] }),
    "x64": a:variable({ name: "x64", bounds: [0.0, 11.0] }),
    "x65": a:variable({ name: "x65", bounds: [0.0, 11.0] }),
    "x66": a:variable({ name: "x66", bounds: [0.0, 11.0] }),
    "x67": a:variable({ name: "x67", bounds: [0.0, 11.0] }),
    "x68": a:variable({ name: "x68", bounds: [0.0, 10.0] }),
    "x69": a:variable({ name: "x69", bounds: [0.0, 10.0] }),
    "x70": a:variable({ name: "x70", bounds: [0.0, 10.0] }),
    "x71": a:variable({ name: "x71", bounds: [0.0, 10.0] }),
    "x72": a:variable({ name: "x72", bounds: [0.0, 10.0] }),
    "x73": a:variable({ name: "x73", bounds: [0.0, 10.0] }),
    "x74": a:variable({ name: "x74", bounds: [0.0, 12.0] }),
    "x75": a:variable({ name: "x75", bounds: [0.0, 12.0] }),
    "x76": a:variable({ name: "x76", bounds: [0.0, 12.0] }),
    "x77": a:variable({ name: "x77", bounds: [0.0, 12.0] }),
    "x78": a:variable({ name: "x78", bounds: [0.0, 12.0] }),
    "x79": a:variable({ name: "x79", bounds: [0.0, 12.0] }),
    "x80": a:variable({ name: "x80", bounds: [0.0, 11.0] }),
    "x81": a:variable({ name: "x81", bounds: [0.0, 11.0] }),
    "x82": a:variable({ name: "x82", bounds: [0.0, 11.0] }),
    "x83": a:variable({ name: "x83", bounds: [0.0, 11.0] }),
    "x84": a:variable({ name: "x84", bounds: [0.0, 11.0] }),
    "x85": a:variable({ name: "x85", bounds: [0.0, 11.0] }),
    ...
    "obj": a:minimize({
        model: ns:supplychainr1_020306#1,
        input: $input,
