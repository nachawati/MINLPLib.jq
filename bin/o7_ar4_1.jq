...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o7_ar4_1";
...
let $input := {
    ...
    "x68": a:variable({ name: "x68", bounds: [2.0, 8.0] }),
    "x69": a:variable({ name: "x69", bounds: [2.0, 8.0] }),
    "x70": a:variable({ name: "x70" }),
    "x71": a:variable({ name: "x71", bounds: [2.0, 8.0] }),
    ...
    "x78": a:variable({ name: "x78", bounds: [3.0, 8.54] }),
    "x79": a:variable({ name: "x79", bounds: [4.2155, 12.0] }),
    ...
    "x88": a:variable({ name: "x88", bounds: [1.5, 6.0] }),
    "x89": a:variable({ name: "x89", bounds: [1.5, 6.0] }),
