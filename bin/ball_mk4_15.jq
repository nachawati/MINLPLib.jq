...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ball_mk4_15";
...
let $input := {
    ...
    "i22": a:variable({ name: "i22", domain: "integer", bounds: [-100.0, null] }),
    "i23": a:variable({ name: "i23", domain: "integer", bounds: [-100.0, null] }),
    "i24": a:variable({ name: "i24", domain: "integer", bounds: [-100.0, null] }),
    "i25": a:variable({ name: "i25", domain: "integer", bounds: [-100.0, null] }),
    "i26": a:variable({ name: "i26", domain: "integer", bounds: [-100.0, null] }),
    "i27": a:variable({ name: "i27", domain: "integer", bounds: [-100.0, null] }),
    "i28": a:variable({ name: "i28", domain: "integer", bounds: [-100.0, null] }),
    "i29": a:variable({ name: "i29", domain: "integer", bounds: [-100.0, null] }),
    "i30": a:variable({ name: "i30", domain: "integer", bounds: [-100.0, null] }),
    "i31": a:variable({ name: "i31", domain: "integer", bounds: [-100.0, null] })
} return {
    "obj": a:minimize({
        model: ns:ball_mk4_15#1,
        input: $input,
