...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_10_2";
...
let $input := {
    ...
    "x62": a:variable({ name: "x62", bounds: [0.599362, 9.400638] }),
    "x63": a:variable({ name: "x63", bounds: [0.599362, 9.400638] }),
    "x64": a:variable({ name: "x64", bounds: [0.599362, 9.400638] }),
    "x65": a:variable({ name: "x65", bounds: [0.599362, 9.400638] }),
    "x66": a:variable({ name: "x66", bounds: [0.342553, 9.657447] }),
    "x67": a:variable({ name: "x67", bounds: [0.342553, 9.657447] }),
    "x68": a:variable({ name: "x68", bounds: [0.342553, 9.657447] }),
    "x69": a:variable({ name: "x69", bounds: [0.342553, 9.657447] }),
    "x70": a:variable({ name: "x70", bounds: [0.85617, 9.14383] }),
    "x71": a:variable({ name: "x71", bounds: [0.85617, 9.14383] }),
    "x72": a:variable({ name: "x72", bounds: [0.85617, 9.14383] }),
    "x73": a:variable({ name: "x73", bounds: [0.85617, 9.14383] }),
    "x74": a:variable({ name: "x74", bounds: [1.52426, 8.47574] }),
    "x75": a:variable({ name: "x75", bounds: [1.52426, 8.47574] }),
    "x76": a:variable({ name: "x76", bounds: [1.52426, 8.47574] }),
    "x77": a:variable({ name: "x77", bounds: [1.52426, 8.47574] }),
    "x78": a:variable({ name: "x78", bounds: [1.93213, 8.06787] }),
    "x79": a:variable({ name: "x79", bounds: [1.93213, 8.06787] }),
    "x80": a:variable({ name: "x80", bounds: [1.93213, 8.06787] }),
    "x81": a:variable({ name: "x81", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_10_2#1,
        input: $input,
