...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/beuster";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [10.0, null] }),
    "x2": a:variable({ name: "x2", bounds: [0.001, null] }),
    "x3": a:variable({ name: "x3", bounds: [1.0, null] }),
    "x4": a:variable({ name: "x4", bounds: [1.0, null] }),
    "x5": a:variable({ name: "x5", bounds: [2.0, null] }),
    "x6": a:variable({ name: "x6", bounds: [1.0, null] }),
    "x7": a:variable({ name: "x7", bounds: [0.1675, null] }),
    ...
    "x15": a:variable({ name: "x15", bounds: [5.0, null] }),
    ...
    "x28": a:variable({ name: "x28", bounds: [0.001, null] }),
    ...
    "x48": a:variable({ name: "x48", bounds: [2.0, 6.0] }),
    "x49": a:variable({ name: "x49", bounds: [2.0, 6.0] }),
    "x50": a:variable({ name: "x50", bounds: [2.0, 6.0] }),
    "x51": a:variable({ name: "x51", bounds: [2.0, 6.0] }),
    "x52": a:variable({ name: "x52", bounds: [1.33, 6.0] }),
    "x53": a:variable({ name: "x53", bounds: [1.33, 6.0] }),
    "x54": a:variable({ name: "x54", bounds: [1.33, 6.0] }),
    "x55": a:variable({ name: "x55", bounds: [1.33, 6.0] }),
    "x56": a:variable({ name: "x56", bounds: [1.13E-8, null] }),
    "x57": a:variable({ name: "x57", bounds: [1.13E-8, null] }),
    "x58": a:variable({ name: "x58", bounds: [1.13E-8, null] }),
    "x59": a:variable({ name: "x59", bounds: [1.13E-8, null] }),
    "x60": a:variable({ name: "x60", bounds: [2.9E-7, null] }),
    "x61": a:variable({ name: "x61", bounds: [2.9E-7, null] }),
    "x62": a:variable({ name: "x62", bounds: [2.9E-7, null] }),
    "x63": a:variable({ name: "x63", bounds: [2.9E-7, null] }),
    "x64": a:variable({ name: "x64", bounds: [3.0E-7, null] }),
    "x65": a:variable({ name: "x65", bounds: [3.0E-7, null] }),
    "x66": a:variable({ name: "x66", bounds: [3.0E-7, null] }),
    "x67": a:variable({ name: "x67", bounds: [3.0E-7, null] }),
    "x68": a:variable({ name: "x68", bounds: [3.0E-10, null] }),
    "x69": a:variable({ name: "x69", bounds: [3.0E-10, null] }),
    "x70": a:variable({ name: "x70", bounds: [3.0E-10, null] }),
    "x71": a:variable({ name: "x71", bounds: [3.0E-10, null] }),
    "x72": a:variable({ name: "x72", bounds: [0.05, null] }),
    "x73": a:variable({ name: "x73", bounds: [0.05, null] }),
    "x74": a:variable({ name: "x74", bounds: [0.05, null] }),
    "x75": a:variable({ name: "x75", bounds: [0.05, null] }),
