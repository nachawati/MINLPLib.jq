...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circlesrectangles_c1r12";
...
let $input := {
    ...
    "x27": a:variable({ name: "x27", bounds: [-0.5, 0.5] }),
    "x28": a:variable({ name: "x28", bounds: [-0.75, 0.75] }),
    "x29": a:variable({ name: "x29", bounds: [-0.5, 0.5] }),
    "x30": a:variable({ name: "x30", bounds: [-0.75, 0.75] }),
    "x31": a:variable({ name: "x31", bounds: [-0.5, 0.5] }),
    "x32": a:variable({ name: "x32", bounds: [-0.75, 0.75] }),
    "x33": a:variable({ name: "x33", bounds: [-0.5, 0.5] }),
    "x34": a:variable({ name: "x34", bounds: [-0.75, 0.75] }),
    ...
    "obj": a:minimize({
        model: ns:kall_circlesrectangles_c1r12#1,
        input: $input,
