...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/turkey";
...
let $input := {
    ...
    "x228": a:variable({ name: "x228", bounds: [409.125, 681.875] }),
    "x229": a:variable({ name: "x229", bounds: [40.2, 67.0] }),
    "x230": a:variable({ name: "x230", bounds: [42.075, 70.125] }),
    "x231": a:variable({ name: "x231", bounds: [637.5, 1062.5] }),
    "x232": a:variable({ name: "x232", bounds: [174.975, 291.625] }),
    "x233": a:variable({ name: "x233", bounds: [16.8, 28.0] }),
    "x234": a:variable({ name: "x234", bounds: [20.55, 34.25] }),
    "x235": a:variable({ name: "x235", bounds: [14.7, 24.5] }),
    "x236": a:variable({ name: "x236", bounds: [8.625, 14.375] }),
    "x237": a:variable({ name: "x237", bounds: [3.75, 6.25] }),
    "x238": a:variable({ name: "x238", bounds: [1.125, 1.875] }),
    "x239": a:variable({ name: "x239", bounds: [5.55, 9.25] }),
    "x240": a:variable({ name: "x240", bounds: [53.175, 88.625] }),
    "x241": a:variable({ name: "x241", bounds: [251.1, 418.5] }),
    ...
    "x266": a:variable({ name: "x266", bounds: [0.0, 46026.0] }),
    "x267": a:variable({ name: "x267", bounds: [0.0, 15109.0] }),
    "x268": a:variable({ name: "x268", bounds: [0.0, 3666.0] }),
    "x269": a:variable({ name: "x269", bounds: [0.0, 15567.1] }),
    "x270": a:variable({ name: "x270", bounds: [0.0, 1040.3] }),
    "x271": a:variable({ name: "x271", bounds: [0.0, 2453.0] }),
    "x272": a:variable({ name: "x272", bounds: [0.0, 58938.7] }),
    ...
    "x404": a:variable({ name: "x404", bounds: [0.0, 18.5] }),
    "x405": a:variable({ name: "x405", bounds: [0.0, 29.6] }),
    "x406": a:variable({ name: "x406", bounds: [0.0, 5.7] }),
    "x407": a:variable({ name: "x407", bounds: [0.0, 75.6] }),
    "x408": a:variable({ name: "x408", bounds: [0.0, 127.0] }),
    "x409": a:variable({ name: "x409", bounds: [0.0, 22.8] }),
    "x410": a:variable({ name: "x410", bounds: [0.0, 6.0] }),
    "x411": a:variable({ name: "x411", bounds: [0.0, 1231.0] }),
    "x412": a:variable({ name: "x412", bounds: [0.0, 10.0] }),
    "x413": a:variable({ name: "x413", bounds: [0.0, 0.5] }),
    "x414": a:variable({ name: "x414", bounds: [0.0, 50.0] }),
    "x415": a:variable({ name: "x415", bounds: [0.0, 0.3] }),
    "x416": a:variable({ name: "x416", bounds: [0.0, 108.0] }),
    "x417": a:variable({ name: "x417", bounds: [0.0, 12.9] }),
    "x418": a:variable({ name: "x418", bounds: [0.0, 76.5] }),
    "x419": a:variable({ name: "x419", bounds: [0.0, 0.4] }),
    "x420": a:variable({ name: "x420", bounds: [0.0, 25.6] }),
    "x421": a:variable({ name: "x421", bounds: [0.0, 1.4] }),
    "x422": a:variable({ name: "x422", bounds: [0.0, 150.6] }),
    "x423": a:variable({ name: "x423", bounds: [0.0, 69.6] }),
    "x424": a:variable({ name: "x424", bounds: [0.0, 23.2] }),
    "x425": a:variable({ name: "x425", bounds: [0.0, 5.4] }),
    "x426": a:variable({ name: "x426", bounds: [0.0, 131.5] }),
    "x427": a:variable({ name: "x427", bounds: [0.0, 8.1] }),
    "x428": a:variable({ name: "x428", bounds: [0.0, 29.7] }),
    "x429": a:variable({ name: "x429", bounds: [0.0, 0.9] }),
    "x430": a:variable({ name: "x430", bounds: [0.0, 0.1] }),
    "x431": a:variable({ name: "x431", bounds: [0.0, 0.1] }),
    "x432": a:variable({ name: "x432", bounds: [0.0, 0.6] }),
    "x433": a:variable({ name: "x433", bounds: [0.0, 7.4] }),
    "x434": a:variable({ name: "x434", bounds: [0.0, 31.0] }),
    "x435": a:variable({ name: "x435", bounds: [0.0, 2.8] }),
    "x436": a:variable({ name: "x436", bounds: [0.0, 0.2] }),
    "x437": a:variable({ name: "x437", bounds: [0.0, 4.0] }),
    "x438": a:variable({ name: "x438", bounds: [0.0, 3.0] }),
    "x439": a:variable({ name: "x439", bounds: [0.0, 18.0] }),
    "x440": a:variable({ name: "x440", bounds: [0.0, 0.3] }),
    "x441": a:variable({ name: "x441", bounds: [0.0, 1.5] }),
