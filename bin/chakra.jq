...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/chakra";
...
let $input := {
    ...
    "x21": a:variable({ name: "x21", bounds: [4.275, 4.275] }),
    ...
    "x41": a:variable({ name: "x41", bounds: [13.7105041437099, 13.7105041437099] }),
