...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex5_2_5";
...
let $input := {
    ...
    "x13": a:variable({ name: "x13", bounds: [0.0, 100.0] }),
    "x14": a:variable({ name: "x14", bounds: [0.0, 200.0] }),
    "x15": a:variable({ name: "x15", bounds: [0.0, 100.0] }),
    ...
    "x21": a:variable({ name: "x21", bounds: [0.0, 100.0] }),
    "x22": a:variable({ name: "x22", bounds: [0.0, 100.0] }),
    "x23": a:variable({ name: "x23", bounds: [0.0, 100.0] }),
    "x24": a:variable({ name: "x24", bounds: [0.0, 200.0] }),
    ...
    "x31": a:variable({ name: "x31", bounds: [0.0, 100.0] }),
