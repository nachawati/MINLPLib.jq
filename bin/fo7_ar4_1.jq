...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo7_ar4_1";
...
let $input := {
    ...
    "x60": a:variable({ name: "x60", bounds: [2.0, 8.0] }),
    "x61": a:variable({ name: "x61", bounds: [2.0, 8.0] }),
    "x62": a:variable({ name: "x62", bounds: [2.0, 8.0] }),
    "x63": a:variable({ name: "x63", bounds: [2.0, 8.0] }),
    "x64": a:variable({ name: "x64", bounds: [2.0, 8.0] }),
    "x65": a:variable({ name: "x65" }),
    "x66": a:variable({ name: "x66", bounds: [2.0, 8.0] }),
    "x67": a:variable({ name: "x67" }),
    "x68": a:variable({ name: "x68", bounds: [3.0, 8.54] }),
    "x69": a:variable({ name: "x69" }),
    "x70": a:variable({ name: "x70", bounds: [4.2155, 12.0] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [1.5, 6.0] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [1.5, 6.0] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [1.5, 6.0] }),
