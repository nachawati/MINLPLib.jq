...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/bchoco05";
...
let $input := {
    ...
    "x14": a:variable({ name: "x14", bounds: [0.001, 10.0] }),
    "x15": a:variable({ name: "x15", bounds: [0.001, 10.0] }),
    "x16": a:variable({ name: "x16", bounds: [0.001, 10.0] }),
    "x17": a:variable({ name: "x17", bounds: [0.001, 10.0] }),
    ...
    "x40": a:variable({ name: "x40", bounds: [0.001, 10.0] }),
    "x41": a:variable({ name: "x41", bounds: [0.001, 10.0] }),
    "x42": a:variable({ name: "x42", bounds: [1.0E-5, 10.0] }),
    "x43": a:variable({ name: "x43", bounds: [0.001, 10.0] }),
    "x44": a:variable({ name: "x44", bounds: [0.001, 10.0] }),
    "x45": a:variable({ name: "x45", bounds: [1.0E-5, 10.0] }),
    "x46": a:variable({ name: "x46", bounds: [0.001, 10.0] }),
    "x47": a:variable({ name: "x47", bounds: [0.001, 10.0] }),
    "x48": a:variable({ name: "x48", bounds: [1.0E-5, 10.0] }),
    "x49": a:variable({ name: "x49", bounds: [-10.0, 10.0] }),
    "x50": a:variable({ name: "x50", bounds: [-10.0, 10.0] }),
    "x51": a:variable({ name: "x51", bounds: [1.0E-5, 10.0] }),
    "x52": a:variable({ name: "x52", bounds: [-10.0, 10.0] }),
    "x53": a:variable({ name: "x53", bounds: [-10.0, 10.0] }),
    "x54": a:variable({ name: "x54", bounds: [1.0E-5, 10.0] }),
    "x55": a:variable({ name: "x55", bounds: [-10.0, 10.0] }),
    "x56": a:variable({ name: "x56", bounds: [-10.0, 10.0] }),
    "x57": a:variable({ name: "x57", bounds: [1.0E-5, 10.0] }),
    ...
    "x61": a:variable({ name: "x61", bounds: [1.0E-5, 10.0] }),
