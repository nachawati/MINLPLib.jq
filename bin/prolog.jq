...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/prolog";

let $input := {
    "x2": a:variable({ name: "x2", bounds: [0.2, null] }),
    "x3": a:variable({ name: "x3", bounds: [0.2, null] }),
    "x4": a:variable({ name: "x4", bounds: [0.2, null] }),
