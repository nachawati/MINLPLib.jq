...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/casctanks";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [7.2, 10.8] }),
    "x2": a:variable({ name: "x2", bounds: [7.2, 10.8] }),
    "x3": a:variable({ name: "x3", bounds: [7.2, 10.8] }),
    "x4": a:variable({ name: "x4", bounds: [7.2, 10.8] }),
    "x5": a:variable({ name: "x5", bounds: [7.2, 10.8] }),
    "x6": a:variable({ name: "x6", bounds: [7.2, 10.8] }),
    "x7": a:variable({ name: "x7", bounds: [7.2, 10.8] }),
    "x8": a:variable({ name: "x8", bounds: [7.2, 10.8] }),
    "x9": a:variable({ name: "x9", bounds: [7.2, 10.8] }),
    "x10": a:variable({ name: "x10", bounds: [7.2, 10.8] }),
    "x11": a:variable({ name: "x11", bounds: [7.2, 10.8] }),
    "x12": a:variable({ name: "x12", bounds: [7.2, 10.8] }),
    "x13": a:variable({ name: "x13", bounds: [7.2, 10.8] }),
    "x14": a:variable({ name: "x14", bounds: [7.2, 10.8] }),
    "x15": a:variable({ name: "x15", bounds: [7.2, 10.8] }),
    "x16": a:variable({ name: "x16", bounds: [7.2, 10.8] }),
    "x17": a:variable({ name: "x17", bounds: [7.2, 10.8] }),
    "x18": a:variable({ name: "x18", bounds: [7.2, 10.8] }),
    "x19": a:variable({ name: "x19", bounds: [7.2, 10.8] }),
    "x20": a:variable({ name: "x20", bounds: [7.2, 10.8] }),
    ...
    "x101": a:variable({ name: "x101", bounds: [0.05, 1.0] }),
    "x102": a:variable({ name: "x102", bounds: [0.05, 1.0] }),
    "x103": a:variable({ name: "x103", bounds: [0.05, 1.0] }),
    "x104": a:variable({ name: "x104", bounds: [0.05, 1.0] }),
    "x105": a:variable({ name: "x105", bounds: [0.05, 1.0] }),
    "x106": a:variable({ name: "x106", bounds: [0.05, 1.0] }),
    "x107": a:variable({ name: "x107", bounds: [0.05, 1.0] }),
    "x108": a:variable({ name: "x108", bounds: [0.05, 1.0] }),
    "x109": a:variable({ name: "x109", bounds: [0.05, 1.0] }),
    "x110": a:variable({ name: "x110", bounds: [0.05, 1.0] }),
    "x111": a:variable({ name: "x111", bounds: [0.05, 1.0] }),
    "x112": a:variable({ name: "x112", bounds: [0.05, 1.0] }),
    "x113": a:variable({ name: "x113", bounds: [0.05, 1.0] }),
    "x114": a:variable({ name: "x114", bounds: [0.05, 1.0] }),
    "x115": a:variable({ name: "x115", bounds: [0.05, 1.0] }),
    "x116": a:variable({ name: "x116", bounds: [0.05, 1.0] }),
    "x117": a:variable({ name: "x117", bounds: [0.05, 1.0] }),
    "x118": a:variable({ name: "x118", bounds: [0.05, 1.0] }),
    "x119": a:variable({ name: "x119", bounds: [0.05, 1.0] }),
    "x120": a:variable({ name: "x120", bounds: [0.75, 0.75] }),
    "x121": a:variable({ name: "x121", bounds: [0.05, 1.0] }),
    "x122": a:variable({ name: "x122", bounds: [0.05, 1.0] }),
    "x123": a:variable({ name: "x123", bounds: [0.05, 1.0] }),
    "x124": a:variable({ name: "x124", bounds: [0.05, 1.0] }),
    "x125": a:variable({ name: "x125", bounds: [0.05, 1.0] }),
    "x126": a:variable({ name: "x126", bounds: [0.05, 1.0] }),
    "x127": a:variable({ name: "x127", bounds: [0.05, 1.0] }),
    "x128": a:variable({ name: "x128", bounds: [0.05, 1.0] }),
    "x129": a:variable({ name: "x129", bounds: [0.05, 1.0] }),
    "x130": a:variable({ name: "x130", bounds: [0.05, 1.0] }),
    "x131": a:variable({ name: "x131", bounds: [0.05, 1.0] }),
    "x132": a:variable({ name: "x132", bounds: [0.05, 1.0] }),
    "x133": a:variable({ name: "x133", bounds: [0.05, 1.0] }),
    "x134": a:variable({ name: "x134", bounds: [0.05, 1.0] }),
    "x135": a:variable({ name: "x135", bounds: [0.05, 1.0] }),
    "x136": a:variable({ name: "x136", bounds: [0.05, 1.0] }),
    "x137": a:variable({ name: "x137", bounds: [0.05, 1.0] }),
    "x138": a:variable({ name: "x138", bounds: [0.05, 1.0] }),
    "x139": a:variable({ name: "x139", bounds: [0.05, 1.0] }),
    "x140": a:variable({ name: "x140", bounds: [0.75, 0.75] }),
    "x141": a:variable({ name: "x141", bounds: [0.05, 1.0] }),
    "x142": a:variable({ name: "x142", bounds: [0.05, 1.0] }),
    "x143": a:variable({ name: "x143", bounds: [0.05, 1.0] }),
    "x144": a:variable({ name: "x144", bounds: [0.05, 1.0] }),
    "x145": a:variable({ name: "x145", bounds: [0.05, 1.0] }),
    "x146": a:variable({ name: "x146", bounds: [0.05, 1.0] }),
    "x147": a:variable({ name: "x147", bounds: [0.05, 1.0] }),
    "x148": a:variable({ name: "x148", bounds: [0.05, 1.0] }),
    "x149": a:variable({ name: "x149", bounds: [0.05, 1.0] }),
    "x150": a:variable({ name: "x150", bounds: [0.05, 1.0] }),
    "x151": a:variable({ name: "x151", bounds: [0.05, 1.0] }),
    "x152": a:variable({ name: "x152", bounds: [0.05, 1.0] }),
    "x153": a:variable({ name: "x153", bounds: [0.05, 1.0] }),
    "x154": a:variable({ name: "x154", bounds: [0.05, 1.0] }),
    "x155": a:variable({ name: "x155", bounds: [0.05, 1.0] }),
    "x156": a:variable({ name: "x156", bounds: [0.05, 1.0] }),
    "x157": a:variable({ name: "x157", bounds: [0.05, 1.0] }),
    "x158": a:variable({ name: "x158", bounds: [0.05, 1.0] }),
    "x159": a:variable({ name: "x159", bounds: [0.05, 1.0] }),
    "x160": a:variable({ name: "x160", bounds: [0.75, 0.75] }),
    "x161": a:variable({ name: "x161", bounds: [0.25, 1.25] }),
    "x162": a:variable({ name: "x162", bounds: [0.25, 1.25] }),
    "x163": a:variable({ name: "x163", bounds: [0.25, 1.25] }),
    "x164": a:variable({ name: "x164", bounds: [0.25, 1.25] }),
    "x165": a:variable({ name: "x165", bounds: [0.25, 1.25] }),
    "x166": a:variable({ name: "x166", bounds: [0.25, 1.25] }),
    "x167": a:variable({ name: "x167", bounds: [0.25, 1.25] }),
    "x168": a:variable({ name: "x168", bounds: [0.25, 1.25] }),
    "x169": a:variable({ name: "x169", bounds: [0.25, 1.25] }),
    "x170": a:variable({ name: "x170", bounds: [0.25, 1.25] }),
    "x171": a:variable({ name: "x171", bounds: [0.25, 1.25] }),
    "x172": a:variable({ name: "x172", bounds: [0.25, 1.25] }),
    "x173": a:variable({ name: "x173", bounds: [0.25, 1.25] }),
    "x174": a:variable({ name: "x174", bounds: [0.25, 1.25] }),
    "x175": a:variable({ name: "x175", bounds: [0.25, 1.25] }),
    "x176": a:variable({ name: "x176", bounds: [0.25, 1.25] }),
    "x177": a:variable({ name: "x177", bounds: [0.25, 1.25] }),
    "x178": a:variable({ name: "x178", bounds: [0.25, 1.25] }),
    "x179": a:variable({ name: "x179", bounds: [0.25, 1.25] }),
    "x180": a:variable({ name: "x180", bounds: [0.25, 1.25] }),
    "x181": a:variable({ name: "x181", bounds: [0.25, 1.25] }),
    "x182": a:variable({ name: "x182", bounds: [0.25, 1.25] }),
    "x183": a:variable({ name: "x183", bounds: [0.25, 1.25] }),
    "x184": a:variable({ name: "x184", bounds: [0.25, 1.25] }),
    "x185": a:variable({ name: "x185", bounds: [0.25, 1.25] }),
    "x186": a:variable({ name: "x186", bounds: [0.25, 1.25] }),
    "x187": a:variable({ name: "x187", bounds: [0.25, 1.25] }),
    "x188": a:variable({ name: "x188", bounds: [0.25, 1.25] }),
    "x189": a:variable({ name: "x189", bounds: [0.25, 1.25] }),
    "x190": a:variable({ name: "x190", bounds: [0.25, 1.25] }),
    "x191": a:variable({ name: "x191", bounds: [0.25, 1.25] }),
    "x192": a:variable({ name: "x192", bounds: [0.25, 1.25] }),
    "x193": a:variable({ name: "x193", bounds: [0.25, 1.25] }),
    "x194": a:variable({ name: "x194", bounds: [0.25, 1.25] }),
    "x195": a:variable({ name: "x195", bounds: [0.25, 1.25] }),
    "x196": a:variable({ name: "x196", bounds: [0.25, 1.25] }),
    "x197": a:variable({ name: "x197", bounds: [0.25, 1.25] }),
    "x198": a:variable({ name: "x198", bounds: [0.25, 1.25] }),
    "x199": a:variable({ name: "x199", bounds: [0.25, 1.25] }),
    "x200": a:variable({ name: "x200", bounds: [0.25, 1.25] }),
    "x201": a:variable({ name: "x201", bounds: [0.25, 1.25] }),
    "x202": a:variable({ name: "x202", bounds: [0.25, 1.25] }),
    "x203": a:variable({ name: "x203", bounds: [0.25, 1.25] }),
    "x204": a:variable({ name: "x204", bounds: [0.25, 1.25] }),
    "x205": a:variable({ name: "x205", bounds: [0.25, 1.25] }),
    "x206": a:variable({ name: "x206", bounds: [0.25, 1.25] }),
    "x207": a:variable({ name: "x207", bounds: [0.25, 1.25] }),
    "x208": a:variable({ name: "x208", bounds: [0.25, 1.25] }),
    "x209": a:variable({ name: "x209", bounds: [0.25, 1.25] }),
    "x210": a:variable({ name: "x210", bounds: [0.25, 1.25] }),
    "x211": a:variable({ name: "x211", bounds: [0.25, 1.25] }),
    "x212": a:variable({ name: "x212", bounds: [0.25, 1.25] }),
    "x213": a:variable({ name: "x213", bounds: [0.25, 1.25] }),
    "x214": a:variable({ name: "x214", bounds: [0.25, 1.25] }),
    "x215": a:variable({ name: "x215", bounds: [0.25, 1.25] }),
    "x216": a:variable({ name: "x216", bounds: [0.25, 1.25] }),
    "x217": a:variable({ name: "x217", bounds: [0.25, 1.25] }),
    "x218": a:variable({ name: "x218", bounds: [0.25, 1.25] }),
    "x219": a:variable({ name: "x219", bounds: [0.25, 1.25] }),
    "x220": a:variable({ name: "x220", bounds: [0.25, 1.25] }),
    "x221": a:variable({ name: "x221", bounds: [0.25, 1.25] }),
    "x222": a:variable({ name: "x222", bounds: [0.25, 1.25] }),
    "x223": a:variable({ name: "x223", bounds: [0.25, 1.25] }),
    "x224": a:variable({ name: "x224", bounds: [0.25, 1.25] }),
    "x225": a:variable({ name: "x225", bounds: [0.25, 1.25] }),
    "x226": a:variable({ name: "x226", bounds: [0.25, 1.25] }),
    "x227": a:variable({ name: "x227", bounds: [0.25, 1.25] }),
    "x228": a:variable({ name: "x228", bounds: [0.25, 1.25] }),
    "x229": a:variable({ name: "x229", bounds: [0.25, 1.25] }),
    "x230": a:variable({ name: "x230", bounds: [0.25, 1.25] }),
    "x231": a:variable({ name: "x231", bounds: [0.25, 1.25] }),
    "x232": a:variable({ name: "x232", bounds: [0.25, 1.25] }),
    "x233": a:variable({ name: "x233", bounds: [0.25, 1.25] }),
    "x234": a:variable({ name: "x234", bounds: [0.25, 1.25] }),
    "x235": a:variable({ name: "x235", bounds: [0.25, 1.25] }),
    "x236": a:variable({ name: "x236", bounds: [0.25, 1.25] }),
    "x237": a:variable({ name: "x237", bounds: [0.25, 1.25] }),
    "x238": a:variable({ name: "x238", bounds: [0.25, 1.25] }),
    "x239": a:variable({ name: "x239", bounds: [0.25, 1.25] }),
    "x240": a:variable({ name: "x240", bounds: [0.25, 1.25] }),
    ...
    "x301": a:variable({ name: "x301", bounds: [0.1, 0.1] }),
    ...
    "x321": a:variable({ name: "x321", bounds: [0.1, 0.1] }),
    ...
    "x341": a:variable({ name: "x341", bounds: [0.1, 0.1] }),
