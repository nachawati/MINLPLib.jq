...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar25_1";
...
let $input := {
    ...
    "x66": a:variable({ name: "x66", bounds: [2.5298, 6.3246] }),
    "x67": a:variable({ name: "x67", bounds: [2.5298, 6.3246] }),
    "x68": a:variable({ name: "x68" }),
    "x69": a:variable({ name: "x69", bounds: [2.5298, 6.3246] }),
    "x70": a:variable({ name: "x70", bounds: [2.5298, 6.3246] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [2.5298, 6.3246] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [2.5298, 6.3246] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [3.7947, 8.54] }),
    "x77": a:variable({ name: "x77", bounds: [4.2155, 9.4868] }),
    "x78": a:variable({ name: "x78", bounds: [1.8974, 4.7434] }),
    "x79": a:variable({ name: "x79" }),
    "x80": a:variable({ name: "x80", bounds: [1.8974, 4.7434] }),
    "x81": a:variable({ name: "x81" }),
    "x82": a:variable({ name: "x82", bounds: [1.8974, 4.7434] }),
    "x83": a:variable({ name: "x83" }),
    "x84": a:variable({ name: "x84", bounds: [1.8974, 4.7434] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [1.8974, 4.7434] }),
    "x87": a:variable({ name: "x87", bounds: [1.8974, 4.7434] }),
