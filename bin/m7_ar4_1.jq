...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/m7_ar4_1";
...
let $input := {
    ...
    "x58": a:variable({ name: "x58", bounds: [2.8, 7.4833] }),
    "x59": a:variable({ name: "x59", bounds: [2.0, 6.3246] }),
    "x60": a:variable({ name: "x60", bounds: [1.8708, 5.0] }),
    "x61": a:variable({ name: "x61", bounds: [1.5811, 5.0] }),
    "x62": a:variable({ name: "x62", bounds: [1.8, 6.0] }),
    "x63": a:variable({ name: "x63" }),
    "x64": a:variable({ name: "x64", bounds: [1.5, 5.0] }),
    "x65": a:variable({ name: "x65" }),
    "x66": a:variable({ name: "x66", bounds: [1.2247, 4.899] }),
    "x67": a:variable({ name: "x67" }),
    "x68": a:variable({ name: "x68", bounds: [1.2247, 4.899] }),
    "x69": a:variable({ name: "x69" }),
    "x70": a:variable({ name: "x70", bounds: [2.0, 6.3246] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [1.5811, 5.0] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [5.0, 10.0] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [2.5, 5.0] }),
    "x77": a:variable({ name: "x77" }),
    "x78": a:variable({ name: "x78", bounds: [5.0, 10.0] }),
    "x79": a:variable({ name: "x79" }),
    "x80": a:variable({ name: "x80", bounds: [2.5, 5.0] }),
