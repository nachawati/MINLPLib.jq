...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn40m03m";
...
let $input := {
    ...
    "x223": a:variable({ name: "x223", bounds: [0.0, 25.0] }),
    "x224": a:variable({ name: "x224", bounds: [0.0, 25.0] }),
    "x225": a:variable({ name: "x225", bounds: [0.0, 25.0] }),
    "x226": a:variable({ name: "x226", bounds: [0.0, 25.0] }),
