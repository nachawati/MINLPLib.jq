...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circles_c6c";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [0.81, 32.0] }),
    ...
    "x14": a:variable({ name: "x14", bounds: [0.7, 7.3] }),
    "x15": a:variable({ name: "x15", bounds: [0.7, 3.3] }),
    "x16": a:variable({ name: "x16", bounds: [0.9, 7.1] }),
    "x17": a:variable({ name: "x17", bounds: [0.9, 3.1] }),
    "x18": a:variable({ name: "x18", bounds: [0.0, 8.0] }),
    "x19": a:variable({ name: "x19", bounds: [0.0, 4.0] }),
    "x20": a:variable({ name: "x20", bounds: [0.0, 32.0] })
} return {
    "obj": a:minimize({
        model: ns:kall_circles_c6c#1,
        input: $input,
