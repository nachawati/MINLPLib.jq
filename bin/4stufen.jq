...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/4stufen";
...
let $input := {
    ...
    "x52": a:variable({ name: "x52", bounds: [1.26, 6.0] }),
    "x53": a:variable({ name: "x53", bounds: [1.26, 6.0] }),
    "x54": a:variable({ name: "x54", bounds: [1.26, 6.0] }),
    "x55": a:variable({ name: "x55", bounds: [1.26, 6.0] }),
    "x56": a:variable({ name: "x56", bounds: [1.13E-5, null] }),
    "x57": a:variable({ name: "x57", bounds: [1.13E-5, null] }),
    "x58": a:variable({ name: "x58", bounds: [1.13E-5, null] }),
    "x59": a:variable({ name: "x59", bounds: [1.13E-5, null] }),
    ...
    "x68": a:variable({ name: "x68", bounds: [3.0E-7, null] }),
    "x69": a:variable({ name: "x69", bounds: [3.0E-7, null] }),
    "x70": a:variable({ name: "x70", bounds: [3.0E-7, null] }),
    "x71": a:variable({ name: "x71", bounds: [3.0E-7, null] }),
