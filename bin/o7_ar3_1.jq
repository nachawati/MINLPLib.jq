...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o7_ar3_1";
...
let $input := {
    ...
    "x68": a:variable({ name: "x68", bounds: [2.3094, 6.9282] }),
    "x69": a:variable({ name: "x69", bounds: [2.3094, 6.9282] }),
    "x70": a:variable({ name: "x70" }),
    "x71": a:variable({ name: "x71", bounds: [2.3094, 6.9282] }),
    ...
    "x78": a:variable({ name: "x78", bounds: [3.4641, 8.54] }),
    "x79": a:variable({ name: "x79", bounds: [4.2155, 10.3923] }),
    ...
    "x88": a:variable({ name: "x88", bounds: [1.7321, 5.1962] }),
    "x89": a:variable({ name: "x89", bounds: [1.7321, 5.1962] }),
