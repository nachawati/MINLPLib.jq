...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn30m02h";
...
let $input := {
    ...
    "x61": a:variable({ name: "x61", bounds: [0.0, 20.0] }),
    ...
    "x114": a:variable({ name: "x114", bounds: [0.0, 30.0] }),
    "x115": a:variable({ name: "x115", bounds: [0.0, 30.0] }),
