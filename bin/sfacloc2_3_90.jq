...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/sfacloc2_3_90";
...
let $input := {
    ...
    "x46": a:variable({ name: "x46", bounds: [1.92, 2.02] }),
    "x47": a:variable({ name: "x47", bounds: [3.82, 4.01333333333333] }),
    "x48": a:variable({ name: "x48", bounds: [4.53333333333333, 4.76] }),
    "x49": a:variable({ name: "x49", bounds: [5.39333333333333, 5.96] }),
    "x50": a:variable({ name: "x50", bounds: [36.3533333333333, 42.0933333333333] }),
    "x51": a:variable({ name: "x51", bounds: [85.7466666666667, 99.28] }),
    "x52": a:variable({ name: "x52", bounds: [6.28, 6.59333333333333] }),
    "x53": a:variable({ name: "x53", bounds: [53.4333333333333, 61.8666666666667] }),
    "x54": a:variable({ name: "x54", bounds: [48.6133333333333, 56.2866666666667] }),
    "x55": a:variable({ name: "x55", bounds: [33.9533333333333, 41.5] }),
    "x56": a:variable({ name: "x56", bounds: [53.9666666666667, 62.4933333333333] }),
    "x57": a:variable({ name: "x57", bounds: [77.0533333333333, 80.9066666666667] }),
    "x58": a:variable({ name: "x58", bounds: [24.9066666666667, 26.1466666666667] }),
    "x59": a:variable({ name: "x59", bounds: [36.1866666666667, 38.0] }),
    "x60": a:variable({ name: "x60", bounds: [56.3133333333333, 62.24] }),
