...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/sfacloc1_2_90";
...
let $input := {
    ...
    "x61": a:variable({ name: "x61", bounds: [0.0, 2.02] }),
    "x62": a:variable({ name: "x62", bounds: [0.0, 4.01333333333333] }),
    "x63": a:variable({ name: "x63", bounds: [0.0, 4.76] }),
    "x64": a:variable({ name: "x64", bounds: [0.0, 5.96] }),
    "x65": a:variable({ name: "x65", bounds: [0.0, 42.0933333333333] }),
    "x66": a:variable({ name: "x66", bounds: [0.0, 99.28] }),
    "x67": a:variable({ name: "x67", bounds: [0.0, 6.59333333333333] }),
    "x68": a:variable({ name: "x68", bounds: [0.0, 61.8666666666667] }),
    "x69": a:variable({ name: "x69", bounds: [0.0, 56.2866666666667] }),
    "x70": a:variable({ name: "x70", bounds: [0.0, 41.5] }),
    "x71": a:variable({ name: "x71", bounds: [0.0, 62.4933333333333] }),
    "x72": a:variable({ name: "x72", bounds: [0.0, 80.9066666666667] }),
    "x73": a:variable({ name: "x73", bounds: [0.0, 26.1466666666667] }),
    "x74": a:variable({ name: "x74", bounds: [0.0, 38.0] }),
    "x75": a:variable({ name: "x75", bounds: [0.0, 62.24] }),
    ...
    "x156": a:variable({ name: "x156", bounds: [0.0, 0.918715169866666] }),
    "x157": a:variable({ name: "x157", bounds: [0.0, 1.021726146] }),
    "x158": a:variable({ name: "x158", bounds: [0.0, 1.0706790744] }),
    "x159": a:variable({ name: "x159", bounds: [0.0, 7.32543671346667] }),
    "x160": a:variable({ name: "x160", bounds: [0.0, 15.2453990736] }),
    "x161": a:variable({ name: "x161", bounds: [0.0, 1.28061192466667] }),
    "x162": a:variable({ name: "x162", bounds: [0.0, 15.8815166933333] }),
    "x163": a:variable({ name: "x163", bounds: [0.0, 15.2472806811333] }),
    "x164": a:variable({ name: "x164", bounds: [0.0, 12.029055125] }),
    "x165": a:variable({ name: "x165", bounds: [0.0, 15.9672360214667] }),
    "x166": a:variable({ name: "x166", bounds: [0.0, 15.3736631157333] }),
    "x167": a:variable({ name: "x167", bounds: [0.0, 6.2237284564] }),
    "x168": a:variable({ name: "x168", bounds: [0.0, 8.85892556] }),
    "x169": a:variable({ name: "x169", bounds: [0.0, 17.2437830768] }),
