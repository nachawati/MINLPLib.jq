...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/m7";
...
let $input := {
    ...
    "x86": a:variable({ name: "x86", bounds: [2.8, 7.4833] }),
    "x87": a:variable({ name: "x87", bounds: [2.0, 6.3246] }),
    "x88": a:variable({ name: "x88", bounds: [1.8, 6.0] }),
    "x89": a:variable({ name: "x89", bounds: [1.2247, 4.899] }),
    "x90": a:variable({ name: "x90", bounds: [2.0, 6.3246] }),
    "x91": a:variable({ name: "x91", bounds: [5.0, 10.0] }),
    "x92": a:variable({ name: "x92", bounds: [5.0, 10.0] }),
    "x93": a:variable({ name: "x93", bounds: [20.0, 20.0] }),
    "x94": a:variable({ name: "x94", bounds: [1.8708, 5.0] }),
    "x95": a:variable({ name: "x95", bounds: [1.5811, 5.0] }),
    "x96": a:variable({ name: "x96", bounds: [1.5, 5.0] }),
    "x97": a:variable({ name: "x97", bounds: [1.2247, 4.899] }),
    "x98": a:variable({ name: "x98", bounds: [1.5811, 5.0] }),
    "x99": a:variable({ name: "x99", bounds: [2.5, 5.0] }),
    "x100": a:variable({ name: "x100", bounds: [2.5, 5.0] }),
    "x101": a:variable({ name: "x101", bounds: [5.0, 5.0] }),
