...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/bchoco06";
...
let $input := {
    ...
    "x42": a:variable({ name: "x42", bounds: [0.001, 10.0] }),
    ...
    "x56": a:variable({ name: "x56", bounds: [1.0E-5, 10.0] }),
    "x57": a:variable({ name: "x57", bounds: [-10.0, 10.0] }),
    "x58": a:variable({ name: "x58", bounds: [-10.0, 10.0] }),
    "x59": a:variable({ name: "x59", bounds: [-10.0, 10.0] }),
    "x60": a:variable({ name: "x60", bounds: [1.0E-5, 10.0] }),
    "x61": a:variable({ name: "x61", bounds: [-10.0, 10.0] }),
    "x62": a:variable({ name: "x62", bounds: [-10.0, 10.0] }),
    "x63": a:variable({ name: "x63", bounds: [-10.0, 10.0] }),
    "x64": a:variable({ name: "x64", bounds: [1.0E-5, 10.0] }),
    "x65": a:variable({ name: "x65", bounds: [-10.0, 10.0] }),
    "x66": a:variable({ name: "x66", bounds: [-10.0, 10.0] }),
    "x67": a:variable({ name: "x67", bounds: [-10.0, 10.0] }),
    "x68": a:variable({ name: "x68", bounds: [1.0E-5, 10.0] }),
    "x69": a:variable({ name: "x69", bounds: [-10.0, 10.0] }),
    "x70": a:variable({ name: "x70", bounds: [-10.0, 10.0] }),
    "x71": a:variable({ name: "x71", bounds: [-10.0, 10.0] }),
    "x72": a:variable({ name: "x72", bounds: [0.001, 10.0] }),
    "x73": a:variable({ name: "x73", bounds: [0.001, 10.0] }),
    "x74": a:variable({ name: "x74", bounds: [0.001, 10.0] }),
    "x75": a:variable({ name: "x75", bounds: [0.001, 10.0] }),
    "x76": a:variable({ name: "x76", bounds: [0.001, 10.0] }),
    "x77": a:variable({ name: "x77", bounds: [0.001, 10.0] }),
    "x78": a:variable({ name: "x78", bounds: [0.001, 10.0] }),
    "x79": a:variable({ name: "x79", bounds: [0.001, 10.0] }),
    "x80": a:variable({ name: "x80", bounds: [0.001, 10.0] }),
    "x81": a:variable({ name: "x81", bounds: [0.0, 10.0] }),
    "x82": a:variable({ name: "x82", bounds: [1.0E-5, 10.0] }),
    "x83": a:variable({ name: "x83", bounds: [-10.0, 10.0] }),
    "x84": a:variable({ name: "x84", bounds: [-10.0, 10.0] }),
    "x85": a:variable({ name: "x85", bounds: [-10.0, 10.0] }),
    "x86": a:variable({ name: "x86", bounds: [-10.0, 10.0] }),
    "x87": a:variable({ name: "x87", bounds: [1.0E-5, 10.0] }),
    "x88": a:variable({ name: "x88", bounds: [-10.0, 10.0] }),
    "x89": a:variable({ name: "x89", bounds: [-10.0, 10.0] }),
    "x90": a:variable({ name: "x90", bounds: [-10.0, 10.0] }),
    ...
    "b112": a:variable({ name: "b112", domain: "binary", bounds: [1.0, 1.0] }),
