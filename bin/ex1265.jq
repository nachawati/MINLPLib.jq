...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex1265";
...
let $input := {
    ...
    "x106": a:variable({ name: "x106", bounds: [0.0, 15.0] }),
    "x107": a:variable({ name: "x107", bounds: [0.0, 12.0] }),
    "x108": a:variable({ name: "x108", bounds: [0.0, 9.0] }),
