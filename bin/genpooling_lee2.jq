...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/genpooling_lee2";
...
let $input := {
    ...
    "x33": a:variable({ name: "x33", bounds: [0.0909, 0.5] }),
    "x34": a:variable({ name: "x34", bounds: [0.125, 0.5455] }),
    "x35": a:variable({ name: "x35", bounds: [0.1428, 0.5195] }),
    "x36": a:variable({ name: "x36", bounds: [0.0909, 0.5] }),
    "x37": a:variable({ name: "x37", bounds: [0.125, 0.5455] }),
    "x38": a:variable({ name: "x38", bounds: [0.1428, 0.5195] }),
    "x39": a:variable({ name: "x39", bounds: [0.0909, 0.5] }),
    "x40": a:variable({ name: "x40", bounds: [0.125, 0.5455] }),
    "x41": a:variable({ name: "x41", bounds: [0.1428, 0.5195] }),
    "x42": a:variable({ name: "x42", bounds: [0.0909, 0.5] }),
    "x43": a:variable({ name: "x43", bounds: [0.125, 0.5455] }),
    "x44": a:variable({ name: "x44", bounds: [0.1428, 0.5195] }),
