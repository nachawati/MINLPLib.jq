...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo7_ar2_1";
...
let $input := {
    ...
    "x60": a:variable({ name: "x60", bounds: [2.8284, 5.6569] }),
    "x61": a:variable({ name: "x61", bounds: [2.8284, 5.6569] }),
    "x62": a:variable({ name: "x62", bounds: [2.8284, 5.6569] }),
    "x63": a:variable({ name: "x63", bounds: [2.8284, 5.6569] }),
    "x64": a:variable({ name: "x64", bounds: [2.8284, 5.6569] }),
    "x65": a:variable({ name: "x65" }),
    "x66": a:variable({ name: "x66", bounds: [2.8284, 5.6569] }),
    "x67": a:variable({ name: "x67" }),
    "x68": a:variable({ name: "x68", bounds: [4.2426, 8.4853] }),
    "x69": a:variable({ name: "x69" }),
    "x70": a:variable({ name: "x70", bounds: [4.2426, 8.4853] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [2.1213, 4.2426] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [2.1213, 4.2426] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [2.1213, 4.2426] }),
    "x77": a:variable({ name: "x77" }),
    "x78": a:variable({ name: "x78", bounds: [2.1213, 4.2426] }),
    "x79": a:variable({ name: "x79" }),
    "x80": a:variable({ name: "x80", bounds: [2.1213, 4.2426] }),
    "x81": a:variable({ name: "x81" }),
    "x82": a:variable({ name: "x82", bounds: [2.1213, 4.2426] }),
