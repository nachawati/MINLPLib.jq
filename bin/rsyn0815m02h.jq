...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/rsyn0815m02h";
...
let $input := {
    ...
    "x628": a:variable({ name: "x628", bounds: [0.0, 40.0] }),
    "x629": a:variable({ name: "x629", bounds: [0.0, 40.0] }),
    ...
    "x650": a:variable({ name: "x650", bounds: [0.0, 30.0] }),
    "x651": a:variable({ name: "x651", bounds: [0.0, 30.0] }),
    ...
    "x685": a:variable({ name: "x685", bounds: [0.0, 20.0] }),
    "x686": a:variable({ name: "x686", bounds: [0.0, 20.0] }),
