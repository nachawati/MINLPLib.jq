...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/cvxnonsep_nsig20r";
...
let $input := {
    ...
    "x11": a:variable({ name: "x11", bounds: [1.0E-5, 10.0] }),
    "x12": a:variable({ name: "x12", bounds: [1.0E-5, 10.0] }),
    "x13": a:variable({ name: "x13", bounds: [1.0E-5, 10.0] }),
    "x14": a:variable({ name: "x14", bounds: [1.0E-5, 10.0] }),
    "x15": a:variable({ name: "x15", bounds: [1.0E-5, 10.0] }),
