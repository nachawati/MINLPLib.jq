...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo7_ar25_1";
...
let $input := {
    ...
    "x60": a:variable({ name: "x60", bounds: [2.5298, 6.3246] }),
    "x61": a:variable({ name: "x61", bounds: [2.5298, 6.3246] }),
    "x62": a:variable({ name: "x62", bounds: [2.5298, 6.3246] }),
    "x63": a:variable({ name: "x63", bounds: [2.5298, 6.3246] }),
    "x64": a:variable({ name: "x64", bounds: [2.5298, 6.3246] }),
    "x65": a:variable({ name: "x65" }),
    "x66": a:variable({ name: "x66", bounds: [2.5298, 6.3246] }),
    "x67": a:variable({ name: "x67" }),
    "x68": a:variable({ name: "x68", bounds: [3.7947, 8.54] }),
    "x69": a:variable({ name: "x69" }),
    "x70": a:variable({ name: "x70", bounds: [4.2155, 9.4868] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [1.8974, 4.7434] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [1.8974, 4.7434] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [1.8974, 4.7434] }),
