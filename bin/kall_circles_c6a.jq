...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circles_c6a";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [0.49, 23.2] }),
