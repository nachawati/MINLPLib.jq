...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex5_3_3";
...
let $input := {
    ...
    "x15": a:variable({ name: "x15", bounds: [0.0, 600.0] }),
    "x16": a:variable({ name: "x16", bounds: [0.0, 600.0] }),
    "x17": a:variable({ name: "x17", bounds: [0.0, 600.0] }),
    "x18": a:variable({ name: "x18", bounds: [0.0, 600.0] }),
    "x19": a:variable({ name: "x19", bounds: [0.0, 600.0] }),
    "x20": a:variable({ name: "x20", bounds: [0.0, 600.0] }),
    "x21": a:variable({ name: "x21", bounds: [0.0, 600.0] }),
    "x22": a:variable({ name: "x22", bounds: [0.0, 600.0] }),
    "x23": a:variable({ name: "x23", bounds: [0.0, 600.0] }),
    ...
    "x30": a:variable({ name: "x30", bounds: [0.0, 600.0] }),
