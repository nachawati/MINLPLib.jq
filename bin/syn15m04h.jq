...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn15m04h";
...
let $input := {
    ...
    "x62": a:variable({ name: "x62", bounds: [0.0, 40.0] }),
    "x63": a:variable({ name: "x63", bounds: [0.0, 40.0] }),
    "x64": a:variable({ name: "x64", bounds: [0.0, 40.0] }),
    "x65": a:variable({ name: "x65", bounds: [0.0, 40.0] }),
    ...
    "x106": a:variable({ name: "x106", bounds: [0.0, 30.0] }),
    "x107": a:variable({ name: "x107", bounds: [0.0, 30.0] }),
    "x108": a:variable({ name: "x108", bounds: [0.0, 30.0] }),
    "x109": a:variable({ name: "x109", bounds: [0.0, 30.0] }),
    ...
    "x174": a:variable({ name: "x174", bounds: [0.0, 20.0] }),
    "x175": a:variable({ name: "x175", bounds: [0.0, 20.0] }),
    ...
    "x179": a:variable({ name: "x179", bounds: [0.0, 20.0] }),
