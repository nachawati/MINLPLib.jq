...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/risk2bpb";
...
let $input := {
    ...
    "x462": a:variable({ name: "x462", bounds: [0.5, null] }),
    "x463": a:variable({ name: "x463", bounds: [0.5, null] }),
    "x464": a:variable({ name: "x464", bounds: [0.5, null] })
} return {
    "obj": a:minimize({
        model: ns:risk2bpb#1,
        input: $input,
