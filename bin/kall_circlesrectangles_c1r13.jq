...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circlesrectangles_c1r13";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [0.25, 7.5] }),
    "x2": a:variable({ name: "x2", bounds: [0.0, 3.0] }),
    "x3": a:variable({ name: "x3", bounds: [0.0, 2.5] }),
    "x4": a:variable({ name: "x4", bounds: [0.0, 3.90512483795333] }),
    "x5": a:variable({ name: "x5", bounds: [0.0, 3.90512483795333] }),
    "x6": a:variable({ name: "x6", bounds: [0.0, 3.90512483795333] }),
    "x7": a:variable({ name: "x7", bounds: [0.0, 3.90512483795333] }),
    "x8": a:variable({ name: "x8", bounds: [-3.90512483795333, 3.90512483795333] }),
    "x9": a:variable({ name: "x9", bounds: [-3.90512483795333, 3.90512483795333] }),
    ...
    "x17": a:variable({ name: "x17", bounds: [-3.90512483795333, 3.90512483795333] }),
    "x18": a:variable({ name: "x18", bounds: [-3.90512483795333, 3.90512483795333] }),
    ...
    "x28": a:variable({ name: "x28", bounds: [-1.5, 1.5] }),
    "x29": a:variable({ name: "x29", bounds: [-1.0, 1.0] }),
    "x30": a:variable({ name: "x30", bounds: [-1.5, 1.5] }),
    "x31": a:variable({ name: "x31", bounds: [-1.0, 1.0] }),
    "x32": a:variable({ name: "x32", bounds: [-1.5, 1.5] }),
    "x33": a:variable({ name: "x33", bounds: [-1.0, 1.0] }),
    "x34": a:variable({ name: "x34", bounds: [-1.5, 1.5] }),
    "x35": a:variable({ name: "x35", bounds: [0.5, 2.5] }),
    "x36": a:variable({ name: "x36", bounds: [0.5, 2.0] }),
    ...
    "x43": a:variable({ name: "x43", bounds: [0.0, 3.0] }),
    "x44": a:variable({ name: "x44", bounds: [0.0, 2.5] }),
    "x45": a:variable({ name: "x45", bounds: [0.0, 3.0] }),
    "x46": a:variable({ name: "x46", bounds: [0.0, 2.5] }),
    "x47": a:variable({ name: "x47", bounds: [0.0, 3.0] }),
    "x48": a:variable({ name: "x48", bounds: [0.0, 2.5] }),
    "x49": a:variable({ name: "x49", bounds: [0.0, 7.5] })
} return {
    "obj": a:minimize({
        model: ns:kall_circlesrectangles_c1r13#1,
        input: $input,
