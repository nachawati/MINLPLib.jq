...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo8_ar5_1";
...
let $input := {
    ...
    "x76": a:variable({ name: "x76", bounds: [1.7889, 8.9443] }),
    "x77": a:variable({ name: "x77", bounds: [1.7889, 8.9443] }),
    "x78": a:variable({ name: "x78", bounds: [1.7889, 8.9443] }),
    "x79": a:variable({ name: "x79", bounds: [1.7889, 8.9443] }),
    "x80": a:variable({ name: "x80", bounds: [1.7889, 8.9443] }),
    "x81": a:variable({ name: "x81" }),
    "x82": a:variable({ name: "x82", bounds: [1.7889, 8.9443] }),
    "x83": a:variable({ name: "x83" }),
    "x84": a:variable({ name: "x84", bounds: [2.7692, 11.31] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [3.183, 13.0] }),
    "x87": a:variable({ name: "x87" }),
    "x88": a:variable({ name: "x88", bounds: [2.7692, 11.31] }),
    "x89": a:variable({ name: "x89" }),
    "x90": a:variable({ name: "x90", bounds: [3.183, 13.0] }),
    "x91": a:variable({ name: "x91" }),
    "x92": a:variable({ name: "x92", bounds: [1.3416, 6.7082] }),
    "x93": a:variable({ name: "x93" }),
    "x94": a:variable({ name: "x94", bounds: [1.3416, 6.7082] }),
    "x95": a:variable({ name: "x95" }),
    "x96": a:variable({ name: "x96", bounds: [1.3416, 6.7082] }),
    "x97": a:variable({ name: "x97" }),
    "x98": a:variable({ name: "x98", bounds: [1.3416, 6.7082] }),
    "x99": a:variable({ name: "x99" }),
    "x100": a:variable({ name: "x100", bounds: [1.3416, 6.7082] }),
    "x101": a:variable({ name: "x101" }),
    "x102": a:variable({ name: "x102", bounds: [1.3416, 6.7082] }),
