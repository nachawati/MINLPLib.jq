...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar3_1";
...
let $input := {
    ...
    "x67": a:variable({ name: "x67", bounds: [2.3094, 6.9282] }),
    "x68": a:variable({ name: "x68" }),
    "x69": a:variable({ name: "x69", bounds: [2.3094, 6.9282] }),
    "x70": a:variable({ name: "x70", bounds: [2.3094, 6.9282] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [2.3094, 6.9282] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [2.3094, 6.9282] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [3.4641, 8.54] }),
    "x77": a:variable({ name: "x77", bounds: [4.2155, 10.3923] }),
    ...
    "x84": a:variable({ name: "x84", bounds: [1.7321, 5.1962] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [1.7321, 5.1962] }),
    "x87": a:variable({ name: "x87", bounds: [1.7321, 5.1962] }),
