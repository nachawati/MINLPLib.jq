...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/watertreatnd_flow";
...
let $input := {
    ...
    "x371": a:variable({ name: "x371", bounds: [0.0, 40.0] }),
    ...
    "x376": a:variable({ name: "x376", bounds: [0.0, 40.0] }),
    "x377": a:variable({ name: "x377", bounds: [0.0, 10.0] }),
    "x378": a:variable({ name: "x378", bounds: [0.0, 10.0] }),
    "x379": a:variable({ name: "x379", bounds: [0.0, 10.0] }),
    "x380": a:variable({ name: "x380", bounds: [0.0, 10.0] }),
    "x381": a:variable({ name: "x381", bounds: [0.0, 40.0] }),
    "x382": a:variable({ name: "x382", bounds: [0.0, 10.0] }),
    "x383": a:variable({ name: "x383", bounds: [0.0, 10.0] }),
    "x384": a:variable({ name: "x384", bounds: [0.0, 10.0] }),
    "x385": a:variable({ name: "x385", bounds: [0.0, 10.0] }),
