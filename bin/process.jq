...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/process";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [10.0, 2000.0] }),
    "x2": a:variable({ name: "x2", bounds: [0.0, 16000.0] }),
    "x3": a:variable({ name: "x3", bounds: [0.0, 120.0] }),
    "x4": a:variable({ name: "x4", bounds: [0.0, 5000.0] }),
