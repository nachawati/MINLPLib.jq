...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn20m03h";
...
let $input := {
    ...
    "x95": a:variable({ name: "x95", bounds: [0.0, 30.0] }),
    "x96": a:variable({ name: "x96", bounds: [0.0, 30.0] }),
    "x97": a:variable({ name: "x97", bounds: [0.0, 30.0] }),
    ...
    "x146": a:variable({ name: "x146", bounds: [0.0, 20.0] }),
    "x147": a:variable({ name: "x147", bounds: [0.0, 20.0] }),
    "x148": a:variable({ name: "x148", bounds: [0.0, 20.0] }),
    "x149": a:variable({ name: "x149", bounds: [0.0, 20.0] }),
    "x150": a:variable({ name: "x150", bounds: [0.0, 20.0] }),
    "x151": a:variable({ name: "x151", bounds: [0.0, 20.0] }),
