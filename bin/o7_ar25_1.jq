...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o7_ar25_1";
...
let $input := {
    ...
    "x68": a:variable({ name: "x68", bounds: [2.5298, 6.3246] }),
    "x69": a:variable({ name: "x69", bounds: [2.5298, 6.3246] }),
    "x70": a:variable({ name: "x70" }),
    "x71": a:variable({ name: "x71", bounds: [2.5298, 6.3246] }),
    ...
    "x78": a:variable({ name: "x78", bounds: [3.7947, 8.54] }),
    "x79": a:variable({ name: "x79", bounds: [4.2155, 9.4868] }),
    ...
    "x88": a:variable({ name: "x88", bounds: [1.8974, 4.7434] }),
    "x89": a:variable({ name: "x89", bounds: [1.8974, 4.7434] }),
