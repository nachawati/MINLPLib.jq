...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex1264";
...
let $input := {
    ...
    "x69": a:variable({ name: "x69", bounds: [0.0, 15.0] }),
    "x70": a:variable({ name: "x70", bounds: [0.0, 12.0] }),
    "x71": a:variable({ name: "x71", bounds: [0.0, 9.0] }),
