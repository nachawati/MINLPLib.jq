...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/multiplants_mtg1c";
...
let $input := {
    ...
    "x193": a:variable({ name: "x193", bounds: [0.0, 0.0] }),
    ...
    "x205": a:variable({ name: "x205", bounds: [0.0, 1200.0] }),
    "x206": a:variable({ name: "x206", bounds: [0.0, 1200.0] }),
    "x207": a:variable({ name: "x207", bounds: [0.0, 1200.0] }),
    "x208": a:variable({ name: "x208", bounds: [0.0, 1200.0] }),
    "x209": a:variable({ name: "x209", bounds: [0.0, 1200.0] }),
    "x210": a:variable({ name: "x210", bounds: [0.0, 1200.0] }),
    "x211": a:variable({ name: "x211", bounds: [0.0, 1200.0] }),
    "x212": a:variable({ name: "x212", bounds: [0.0, 1200.0] }),
    "x213": a:variable({ name: "x213", bounds: [0.0, 1200.0] }),
    "x214": a:variable({ name: "x214", bounds: [0.0, 1200.0] }),
    "x215": a:variable({ name: "x215", bounds: [0.0, 1200.0] }),
    "x216": a:variable({ name: "x216", bounds: [0.0, 1200.0] }),
    ...
    "x220": a:variable({ name: "x220", bounds: [0.0, 600.0] }),
    "x221": a:variable({ name: "x221", bounds: [0.0, 600.0] }),
    "x222": a:variable({ name: "x222", bounds: [0.0, 600.0] }),
    "x223": a:variable({ name: "x223", bounds: [0.0, 600.0] }),
    "x224": a:variable({ name: "x224", bounds: [0.0, 600.0] }),
    "x225": a:variable({ name: "x225", bounds: [0.0, 600.0] }),
    "x226": a:variable({ name: "x226", bounds: [0.0, 1200.0] }),
    "x227": a:variable({ name: "x227", bounds: [0.0, 1200.0] }),
    "x228": a:variable({ name: "x228", bounds: [0.0, 1200.0] }),
    "x229": a:variable({ name: "x229", bounds: [0.0, 1200.0] }),
    "x230": a:variable({ name: "x230", bounds: [0.0, 1200.0] }),
    "x231": a:variable({ name: "x231", bounds: [0.0, 1200.0] }),
    "x232": a:variable({ name: "x232", bounds: [50.0, null] }),
    "x233": a:variable({ name: "x233", bounds: [100.0, null] }),
    "x234": a:variable({ name: "x234", bounds: [250.0, null] }),
    ...
    "x241": a:variable({ name: "x241", bounds: [11.1111111111111, 600.0] }),
    "x242": a:variable({ name: "x242", bounds: [33.3333333333333, 600.0] }),
    "x243": a:variable({ name: "x243", bounds: [45.4545454545455, 600.0] }),
    "x244": a:variable({ name: "x244", bounds: [200.0, 600.0] }),
    "x245": a:variable({ name: "x245" })
} return {
    "obj": a:maximize({
        model: ns:multiplants_mtg1c#1,
        input: $input,
