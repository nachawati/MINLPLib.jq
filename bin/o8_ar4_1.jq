...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o8_ar4_1";
...
let $input := {
    ...
    "x92": a:variable({ name: "x92", bounds: [2.0, 8.0] }),
    "x93": a:variable({ name: "x93", bounds: [2.0, 8.0] }),
    ...
    "x102": a:variable({ name: "x102", bounds: [3.0, 11.31] }),
    "x103": a:variable({ name: "x103", bounds: [3.183, 12.0] }),
    "x104": a:variable({ name: "x104", bounds: [3.0, 11.31] }),
    "x105": a:variable({ name: "x105", bounds: [3.183, 12.0] }),
    "x106": a:variable({ name: "x106", bounds: [1.5, 6.0] }),
    "x107": a:variable({ name: "x107" }),
    "x108": a:variable({ name: "x108", bounds: [1.5, 6.0] }),
    ...
    "x115": a:variable({ name: "x115", bounds: [1.5, 6.0] }),
