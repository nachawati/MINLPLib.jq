...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/kall_circlespolygons_c1p12";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [0.25, 32.0] }),
    "x2": a:variable({ name: "x2", bounds: [-1.0, 1.0] }),
    "x3": a:variable({ name: "x3", bounds: [-1.0, 1.0] }),
    "x4": a:variable({ name: "x4", bounds: [0.0, 8.0] }),
    ...
    "x13": a:variable({ name: "x13", bounds: [-8.94427190999916, 8.94427190999916] }),
    "x14": a:variable({ name: "x14", bounds: [-8.94427190999916, 8.94427190999916] }),
    ...
    "x29": a:variable({ name: "x29", bounds: [0.5, 7.5] }),
    "x30": a:variable({ name: "x30", bounds: [0.5, 3.5] }),
    "x31": a:variable({ name: "x31", bounds: [0.0, 8.0] }),
    "x32": a:variable({ name: "x32", bounds: [0.0, 4.0] }),
    "x33": a:variable({ name: "x33", bounds: [0.0, 8.0] }),
    "x34": a:variable({ name: "x34", bounds: [0.0, 4.0] }),
    "x35": a:variable({ name: "x35", bounds: [0.0, 8.0] }),
    ...
    "x43": a:variable({ name: "x43", bounds: [0.0, 32.0] })
} return {
    "obj": a:minimize({
        model: ns:kall_circlespolygons_c1p12#1,
        input: $input,
