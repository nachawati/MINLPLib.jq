...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o7_ar5_1";
...
let $input := {
    ...
    "x68": a:variable({ name: "x68", bounds: [1.7889, 8.54] }),
    "x69": a:variable({ name: "x69", bounds: [1.7889, 8.54] }),
    "x70": a:variable({ name: "x70" }),
    "x71": a:variable({ name: "x71", bounds: [1.8735, 8.9443] }),
    "x72": a:variable({ name: "x72", bounds: [1.8735, 8.9443] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [1.7889, 8.54] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [1.8735, 8.9443] }),
    "x77": a:variable({ name: "x77" }),
    "x78": a:variable({ name: "x78", bounds: [2.7692, 8.54] }),
    "x79": a:variable({ name: "x79", bounds: [4.2155, 13.0] }),
    ...
    "x88": a:variable({ name: "x88", bounds: [1.3416, 6.7082] }),
    "x89": a:variable({ name: "x89", bounds: [1.3416, 6.7082] }),
