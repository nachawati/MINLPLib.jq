...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn10m04h";
...
let $input := {
    ...
    "x44": a:variable({ name: "x44", bounds: [0.0, 40.0] }),
    "x45": a:variable({ name: "x45", bounds: [0.0, 40.0] }),
