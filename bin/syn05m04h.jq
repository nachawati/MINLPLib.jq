...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/syn05m04h";
...
let $input := {
    ...
    "x24": a:variable({ name: "x24", bounds: [0.0, 40.0] }),
    "x25": a:variable({ name: "x25", bounds: [0.0, 40.0] }),
