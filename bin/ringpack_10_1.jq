...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ringpack_10_1";
...
let $input := {
    ...
    "x52": a:variable({ name: "x52", bounds: [0.599362, 9.400638] }),
    "x53": a:variable({ name: "x53", bounds: [0.599362, 9.400638] }),
    "x54": a:variable({ name: "x54", bounds: [0.599362, 9.400638] }),
    "x55": a:variable({ name: "x55", bounds: [0.599362, 9.400638] }),
    "x56": a:variable({ name: "x56", bounds: [0.342553, 9.657447] }),
    "x57": a:variable({ name: "x57", bounds: [0.342553, 9.657447] }),
    "x58": a:variable({ name: "x58", bounds: [0.342553, 9.657447] }),
    "x59": a:variable({ name: "x59", bounds: [0.342553, 9.657447] }),
    "x60": a:variable({ name: "x60", bounds: [0.85617, 9.14383] }),
    "x61": a:variable({ name: "x61", bounds: [0.85617, 9.14383] }),
    "x62": a:variable({ name: "x62", bounds: [0.85617, 9.14383] }),
    "x63": a:variable({ name: "x63", bounds: [0.85617, 9.14383] }),
    "x64": a:variable({ name: "x64", bounds: [1.52426, 8.47574] }),
    "x65": a:variable({ name: "x65", bounds: [1.52426, 8.47574] }),
    "x66": a:variable({ name: "x66", bounds: [1.52426, 8.47574] }),
    "x67": a:variable({ name: "x67", bounds: [1.52426, 8.47574] }),
    "x68": a:variable({ name: "x68", bounds: [1.93213, 8.06787] }),
    "x69": a:variable({ name: "x69", bounds: [1.93213, 8.06787] }),
    "x70": a:variable({ name: "x70", bounds: [1.93213, 8.06787] }),
    "x71": a:variable({ name: "x71", bounds: [1.93213, 8.06787] })
} return {
    "obj": a:minimize({
        model: ns:ringpack_10_1#1,
        input: $input,
