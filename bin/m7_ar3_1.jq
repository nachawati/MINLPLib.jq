...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/m7_ar3_1";
...
let $input := {
    ...
    "x58": a:variable({ name: "x58", bounds: [2.8, 6.4807] }),
    "x59": a:variable({ name: "x59", bounds: [2.0, 5.4772] }),
    "x60": a:variable({ name: "x60", bounds: [2.1602, 5.0] }),
    "x61": a:variable({ name: "x61", bounds: [1.8257, 5.0] }),
    "x62": a:variable({ name: "x62", bounds: [1.8, 5.1962] }),
    "x63": a:variable({ name: "x63" }),
    "x64": a:variable({ name: "x64", bounds: [1.7321, 5.0] }),
    "x65": a:variable({ name: "x65" }),
    "x66": a:variable({ name: "x66", bounds: [1.4142, 4.2426] }),
    "x67": a:variable({ name: "x67" }),
    "x68": a:variable({ name: "x68", bounds: [1.4142, 4.2426] }),
    "x69": a:variable({ name: "x69" }),
    "x70": a:variable({ name: "x70", bounds: [2.0, 5.4772] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [1.8257, 5.0] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [5.0, 8.6603] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [2.8868, 5.0] }),
    "x77": a:variable({ name: "x77" }),
    "x78": a:variable({ name: "x78", bounds: [5.0, 8.6603] }),
    "x79": a:variable({ name: "x79" }),
    "x80": a:variable({ name: "x80", bounds: [2.8868, 5.0] }),
