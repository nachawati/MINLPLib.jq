...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo7_2";
...
let $input := {
    ...
    "x86": a:variable({ name: "x86", bounds: [1.7889, 8.54] }),
    "x87": a:variable({ name: "x87", bounds: [1.7889, 8.54] }),
    "x88": a:variable({ name: "x88", bounds: [1.7889, 8.54] }),
    "x89": a:variable({ name: "x89", bounds: [2.7692, 8.5399] }),
    "x90": a:variable({ name: "x90", bounds: [1.3416, 6.7082] }),
    "x91": a:variable({ name: "x91", bounds: [1.3416, 6.7082] }),
    "x92": a:variable({ name: "x92", bounds: [1.3416, 6.7082] }),
    "x93": a:variable({ name: "x93", bounds: [8.54, 8.54] }),
    "x94": a:variable({ name: "x94", bounds: [1.8735, 8.944] }),
    "x95": a:variable({ name: "x95", bounds: [1.8735, 8.944] }),
    "x96": a:variable({ name: "x96", bounds: [1.8735, 8.944] }),
    "x97": a:variable({ name: "x97", bounds: [4.2155, 13.0] }),
    "x98": a:variable({ name: "x98", bounds: [1.3416, 6.7082] }),
    "x99": a:variable({ name: "x99", bounds: [1.3416, 6.7082] }),
