...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/no7_ar2_1";
...
let $input := {
    ...
    "x67": a:variable({ name: "x67", bounds: [2.8284, 5.6569] }),
    "x68": a:variable({ name: "x68" }),
    "x69": a:variable({ name: "x69", bounds: [2.8284, 5.6569] }),
    "x70": a:variable({ name: "x70", bounds: [2.8284, 5.6569] }),
    "x71": a:variable({ name: "x71" }),
    "x72": a:variable({ name: "x72", bounds: [2.8284, 5.6569] }),
    "x73": a:variable({ name: "x73" }),
    "x74": a:variable({ name: "x74", bounds: [2.8284, 5.6569] }),
    "x75": a:variable({ name: "x75" }),
    "x76": a:variable({ name: "x76", bounds: [4.2426, 8.4853] }),
    "x77": a:variable({ name: "x77", bounds: [4.2426, 8.4853] }),
    ...
    "x84": a:variable({ name: "x84", bounds: [2.1213, 4.2426] }),
    "x85": a:variable({ name: "x85" }),
    "x86": a:variable({ name: "x86", bounds: [2.1213, 4.2426] }),
    "x87": a:variable({ name: "x87", bounds: [2.1213, 4.2426] }),
