...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/ex1244";

let $input := {
    "x1": a:variable({ name: "x1", bounds: [77.0, 159.0] }),
    "x2": a:variable({ name: "x2", bounds: [77.0, 159.0] }),
    "x3": a:variable({ name: "x3", bounds: [77.0, 159.0] }),
    "x4": a:variable({ name: "x4", bounds: [77.0, 159.0] }),
    "x5": a:variable({ name: "x5", bounds: [80.0, 267.0] }),
    "x6": a:variable({ name: "x6", bounds: [80.0, 267.0] }),
    "x7": a:variable({ name: "x7", bounds: [80.0, 267.0] }),
    "x8": a:variable({ name: "x8", bounds: [80.0, 267.0] }),
    "x9": a:variable({ name: "x9", bounds: [90.0, 343.0] }),
    "x10": a:variable({ name: "x10", bounds: [90.0, 343.0] }),
    "x11": a:variable({ name: "x11", bounds: [90.0, 343.0] }),
    "x12": a:variable({ name: "x12", bounds: [90.0, 343.0] }),
    "x13": a:variable({ name: "x13", bounds: [26.0, 127.0] }),
    "x14": a:variable({ name: "x14", bounds: [26.0, 127.0] }),
    "x15": a:variable({ name: "x15", bounds: [26.0, 127.0] }),
    "x16": a:variable({ name: "x16", bounds: [26.0, 127.0] }),
    "x17": a:variable({ name: "x17", bounds: [118.0, 265.0] }),
    "x18": a:variable({ name: "x18", bounds: [118.0, 265.0] }),
    "x19": a:variable({ name: "x19", bounds: [118.0, 265.0] }),
    "x20": a:variable({ name: "x20", bounds: [118.0, 265.0] }),
