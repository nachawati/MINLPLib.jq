...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/o9_ar4_1";
...
let $input := {
    ...
    "x108": a:variable({ name: "x108", bounds: [2.0, 8.0] }),
    "x109": a:variable({ name: "x109", bounds: [2.0, 8.0] }),
    "x110": a:variable({ name: "x110" }),
    "x111": a:variable({ name: "x111", bounds: [2.0, 8.0] }),
    "x112": a:variable({ name: "x112", bounds: [2.0, 8.0] }),
    ...
    "x118": a:variable({ name: "x118", bounds: [3.0, 12.0] }),
    "x119": a:variable({ name: "x119", bounds: [3.0, 12.0] }),
    "x120": a:variable({ name: "x120", bounds: [3.0, 12.0] }),
    "x121": a:variable({ name: "x121", bounds: [3.0, 12.0] }),
    ...
    "x126": a:variable({ name: "x126", bounds: [1.5, 6.0] }),
    ...
    "x132": a:variable({ name: "x132", bounds: [1.5, 6.0] }),
    "x133": a:variable({ name: "x133" }),
    "x134": a:variable({ name: "x134", bounds: [1.5, 6.0] }),
    "x135": a:variable({ name: "x135", bounds: [1.5, 6.0] }),
