...
import module namespace ns = "http://dgms.io/contrib/models/minlplib/fo9_ar4_1";
...
let $input := {
    ...
    "x97": a:variable({ name: "x97", bounds: [2.0, 8.0] }),
    "x98": a:variable({ name: "x98", bounds: [2.0, 8.0] }),
    "x99": a:variable({ name: "x99" }),
    "x100": a:variable({ name: "x100", bounds: [2.0, 8.0] }),
    "x101": a:variable({ name: "x101" }),
    "x102": a:variable({ name: "x102", bounds: [3.0, 12.0] }),
    "x103": a:variable({ name: "x103" }),
    "x104": a:variable({ name: "x104", bounds: [3.0, 12.0] }),
    "x105": a:variable({ name: "x105" }),
    "x106": a:variable({ name: "x106", bounds: [3.0, 12.0] }),
    "x107": a:variable({ name: "x107" }),
    "x108": a:variable({ name: "x108", bounds: [3.0, 12.0] }),
    "x109": a:variable({ name: "x109" }),
    "x110": a:variable({ name: "x110", bounds: [1.5, 6.0] }),
    "x111": a:variable({ name: "x111" }),
    "x112": a:variable({ name: "x112", bounds: [1.5, 6.0] }),
    "x113": a:variable({ name: "x113" }),
    "x114": a:variable({ name: "x114", bounds: [1.5, 6.0] }),
    "x115": a:variable({ name: "x115" }),
    "x116": a:variable({ name: "x116", bounds: [1.5, 6.0] }),
    "x117": a:variable({ name: "x117" }),
    "x118": a:variable({ name: "x118", bounds: [1.5, 6.0] }),
    "x119": a:variable({ name: "x119" }),
    "x120": a:variable({ name: "x120", bounds: [1.5, 6.0] }),
    "x121": a:variable({ name: "x121" }),
    "x122": a:variable({ name: "x122", bounds: [1.5, 6.0] }),
    "x123": a:variable({ name: "x123" }),
    "x124": a:variable({ name: "x124", bounds: [1.5, 6.0] }),
